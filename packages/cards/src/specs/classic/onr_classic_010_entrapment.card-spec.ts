...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_classic_010_entrapment"),
    title: "Entrapment",
    side: "corp",
    cardType: "ice",
  },
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_classic_010_entrapment",
      },
    ],
  },
  engine: {
  ...
  planningAnnotations: {
    ...
    card: [
      ...
      },
      {
        ...
        severity: "medium",
        rationale:
          "Migrated from reviewed Classic hint onr_classic_010_entrapment.",
      },
      {
        kind: "risk_interpretation",
        risk: "reserve_risk",
  ...
  printings: [
    {
      ...
      printingId: "onr_classic_010_entrapment",
      setId: "classic",
      collectorNumber: "C010",
      rarity: "common",
    },
  ],
  publication: {
