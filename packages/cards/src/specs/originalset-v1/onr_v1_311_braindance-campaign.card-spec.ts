...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_311_braindance-campaign"),
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_311_braindance-campaign",
      },
    ],
  },
  engine: {
    ...
    characteristics: {
      ...
      subtypes: ["advertisement", "gray ops"],
      numeric: {
        installCost: null,
        memoryCost: null,
        rezCost: 6,
  ...
  planningAnnotations: {
    ...
    card: [
      ...
      },
      {
        ...
        confidence: "medium",
        rationale:
          "Start-of-turn installed economy creates asset-economy pressure; Gray Ops remains only a subtype. Node/Asset type and subtypes remain card data and are not mirrored as tactic signals.",
      },
      {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_311_braindance-campaign",
