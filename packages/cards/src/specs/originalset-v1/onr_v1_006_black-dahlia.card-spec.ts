...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_006_black-dahlia"),
    title: "Black Dahlia",
    side: "runner",
    cardType: "program",
  },
  text: {
    ...
    rulesText: "2 credits: Break sentry subroutine.\n2 credits: +1 strength.",
  },
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_006_black-dahlia",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_006_black-dahlia",
