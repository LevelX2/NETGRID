...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_248_homewrecker"),
    title: "Homewrecker™",
    side: "corp",
    cardType: "ice",
  },
  text: {
    ...
    rulesText:
      "[Subroutine] Trace 5 - If trace is successful, end the run, trash a piece of hardware, and do 2 meat damage. This damage cannot be prevented.",
  },
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_248_homewrecker",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_248_homewrecker",
