...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_302_scorched-earth"),
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_302_scorched-earth",
      },
    ],
  },
  engine: {
  ...
  planningAnnotations: {
    ...
    card: [
      ...
      },
      {
        ...
        role: "win_condition",
        roleDetail: "tagged_meat_damage_closeout",
        confidence: "high",
        rationale:
          "Operations Semantic Review v2: tagged_meat_damage_closeout.",
      },
      {
        kind: "strategy_support",
        strategyKey: "corp.tag_trace_punish",
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_302_scorched-earth",
