...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_008_boardwalk"),
    title: "Boardwalk",
    side: "runner",
    cardType: "program",
  },
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_008_boardwalk",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_008_boardwalk",
