...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_242_fatal-attractor"),
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_242_fatal-attractor",
      },
    ],
  },
  engine: {
  ...
  planningAnnotations: {
    ...
    card: [
      ...
      },
      {
        ...
        confidence: "medium",
        rationale:
          "ICE Semantic Review v1: Fatal Attractor bestätigt corp.damage_kill nur aus konkreten ICE-Funktionssignalen; Subtypen bleiben Kartendaten.",
      },
      {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_242_fatal-attractor",
