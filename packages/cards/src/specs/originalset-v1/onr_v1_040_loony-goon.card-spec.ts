...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_040_loony-goon"),
    title: "Loony Goon",
    side: "runner",
    cardType: "program",
  },
  text: {
    ...
    rulesText: "1 credit: Break sentry subroutine.\n1 credit: +1 strength.",
  },
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_040_loony-goon",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_040_loony-goon",
