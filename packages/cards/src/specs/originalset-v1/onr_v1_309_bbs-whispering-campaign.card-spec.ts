...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_309_bbs-whispering-campaign"),
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_309_bbs-whispering-campaign",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_309_bbs-whispering-campaign",
