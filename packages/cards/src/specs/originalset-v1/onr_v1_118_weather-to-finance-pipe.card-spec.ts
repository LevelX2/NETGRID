...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_118_weather-to-finance-pipe"),
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_118_weather-to-finance-pipe",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_118_weather-to-finance-pipe",
