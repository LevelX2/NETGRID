...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_016_cyfermaster"),
    title: "Cyfermaster™",
    side: "runner",
    cardType: "program",
  },
  text: {
    ...
    rulesText: "2 credits: Break code gate subroutine.\n1 credit: +1 strength.",
  },
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_016_cyfermaster",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_016_cyfermaster",
