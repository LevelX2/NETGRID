...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_072_wild-card"),
    title: "Wild Card",
    side: "runner",
    cardType: "program",
  },
  text: {
    ...
    rulesText: "0 credits: Break sentry subroutine.\n3 credits: +1 strength.",
  },
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_072_wild-card",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_072_wild-card",
