...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_229_code-corpse"),
    title: "Code Corpse",
    side: "corp",
    cardType: "ice",
  },
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_229_code-corpse",
      },
    ],
  },
  engine: {
  ...
  planningAnnotations: {
    ...
    card: [
      ...
      },
      {
        ...
        confidence: "high",
        rationale:
          "ICE Semantic Review v1: Code Corpse bestätigt corp.damage_kill nur aus konkreten ICE-Funktionssignalen; Subtypen bleiben Kartendaten.",
      },
      {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_229_code-corpse",
