...
export const cardSpec = {
  ...
  rules: {
    ...
    references: [
      ...
      },
      {
        ...
        reference:
          "docs/source/Netrunner Errata 1.70.md#Arasaka Portable Prototype",
  ...
  planningAnnotations: {
    ...
    card: [
      ...
      { kind: "plan_role", role: "memory_support" },
      { kind: "plan_role", role: "icebreaker_credit_support" },
      {
