...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_073_wizards-book"),
    title: "Wizard’s Book",
    side: "runner",
    cardType: "program",
  },
  text: {
    ...
    rulesText: "[0]: Break code gate subroutine.\n[2]: +1 strength.",
  },
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_073_wizards-book",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_073_wizards-book",
