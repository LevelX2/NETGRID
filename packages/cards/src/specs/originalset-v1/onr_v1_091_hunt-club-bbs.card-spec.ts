...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_091_hunt-club-bbs"),
    title: "Hunt Club BBS",
    side: "runner",
    cardType: "event",
  },
  text: {
    ...
    rulesText: "Expose up to three installed cards.",
  },
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_v1_091_hunt-club-bbs",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_v1_091_hunt-club-bbs",
