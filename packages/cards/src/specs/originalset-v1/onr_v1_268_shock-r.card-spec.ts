...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_v1_268_shock-r"),
    title: "Shock.r",
    side: "corp",
    cardType: "ice",
  },
  ...
  planningAnnotations: {
    ...
    card: [
      ...
      },
      {
        ...
        confidence: "medium",
        rationale:
          "ICE Semantic Review v1: Shock.r bestätigt corp.ice_tax_glacier nur aus konkreten ICE-Funktionssignalen; Subtypen bleiben Kartendaten.",
      },
    ],
    capabilities: [],
  },
