...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("v08_cashout_asset"),
    title: "Cashout Asset",
    side: "corp",
    cardType: "asset",
  },
  ...
  planningAnnotations: {
    ...
    card: [
      ...
      },
      {
        ...
        axis: "economy",
        rating: "high",
        rationale: "Migrated from reviewed Testset hint v08_cashout_asset.",
      },
      {
        kind: "value_interpretation",
  ...
  printings: [
    {
      ...
      printingId: "v08_cashout_asset",
      setId: "testset",
      collectorNumber: "V08-011",
    },
  ],
  publication: {
