...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_118_prearranged-drop"),
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_118_prearranged-drop",
      },
    ],
  },
  engine: {
    ...
    abilities: [
      {
        capabilityKey: capabilityKey(
          "on_play_mark_next_agenda_access_credit_gain",
        ),
  ...
  printings: [
    {
      ...
      printingId: "onr_proteus_118_prearranged-drop",
      setId: "proteus",
      collectorNumber: "P118",
      rarity: "rare",
    },
  ],
  publication: {
