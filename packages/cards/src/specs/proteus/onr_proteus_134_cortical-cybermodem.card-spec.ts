...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_134_cortical-cybermodem"),
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_134_cortical-cybermodem",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_proteus_134_cortical-cybermodem",
      setId: "proteus",
      collectorNumber: "P134",
      rarity: "common",
    },
  ],
  publication: {
