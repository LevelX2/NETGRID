...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_102_blackmail"),
    title: "Blackmail",
    side: "runner",
    cardType: "event",
  },
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_102_blackmail",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_proteus_102_blackmail",
      setId: "proteus",
      collectorNumber: "P102",
      rarity: "rare",
    },
  ],
  publication: {
