...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_023_galatea"),
    title: "Galatea",
    side: "corp",
    cardType: "ice",
  },
  text: {
    ...
    rulesText:
      "*End the run. When you rez Galatea, you may pay [1], above the rez cost, to make it a code gate instead of a wall.",
  },
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_023_galatea",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_proteus_023_galatea",
      setId: "proteus",
      collectorNumber: "P023",
      rarity: "common",
    },
  ],
  publication: {
