...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_033_mobile-barricade"),
  ...
  text: {
    ...
    rulesText:
      "*Do 1 Net damage. *End the run. [1]: Move Mobile Barricade and insert it in a different position on this data fort. Use this ability only at the start of a run on this data fort. You may use this ability even if Mobile Barricade is unrezzed, in which case, you reveal it.",
  },
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_033_mobile-barricade",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_proteus_033_mobile-barricade",
      setId: "proteus",
      collectorNumber: "P033",
      rarity: "rare",
    },
  ],
  publication: {
