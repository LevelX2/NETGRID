...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_117_poisoned-water-supply"),
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_117_poisoned-water-supply",
      },
    ],
  },
  engine: {
    ...
    runnerEventLongtail: {
      capabilityKey: capabilityKey("trash_two_connections_add_bad_publicity"),
  ...
  planningAnnotations: {
    ...
    card: [
      {
        kind: "plan_role",
        role: "bad_publicity_pressure",
      },
      {
        kind: "risk_interpretation",
        risk: "installed_connection_sacrifice",
        severity: "high",
      },
    ],
    capabilities: [],
  ...
  printings: [
    {
      ...
      printingId: "onr_proteus_117_poisoned-water-supply",
      setId: "proteus",
      collectorNumber: "P117",
      rarity: "rare",
    },
  ],
  publication: {
