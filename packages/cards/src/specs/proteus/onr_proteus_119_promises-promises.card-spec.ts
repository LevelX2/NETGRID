...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_119_promises-promises"),
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_119_promises-promises",
      },
    ],
  },
  engine: {
    ...
    abilities: [
      {
        capabilityKey: capabilityKey(
          "on_play_mark_next_agenda_access_point_gain",
        ),
  ...
  printings: [
    {
      ...
      printingId: "onr_proteus_119_promises-promises",
      setId: "proteus",
      collectorNumber: "P119",
      rarity: "rare",
    },
  ],
  publication: {
