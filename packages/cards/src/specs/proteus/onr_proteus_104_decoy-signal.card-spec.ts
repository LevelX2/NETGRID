...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_104_decoy-signal"),
    title: "Decoy Signal",
    side: "runner",
    cardType: "event",
  },
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_104_decoy-signal",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_proteus_104_decoy-signal",
      setId: "proteus",
      collectorNumber: "P104",
      rarity: "common",
    },
  ],
  publication: {
