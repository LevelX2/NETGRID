...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_065_networked-center"),
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_065_networked-center",
      },
    ],
  },
  engine: {
  ...
  planningAnnotations: {
    ...
    card: [
      ...
      },
      {
        ...
        strategyKey: "corp.remote_scoring",
        role: "scoring_tool",
        roleDetail: "gray_ops_agenda_difficulty_discount",
        evidenceProfile: "gray_ops_agenda_difficulty_discount",
        confidence: "high",
        rationale:
          "Gray Ops agenda difficulty discount supports remote scoring.",
      },
      {
      ...
      },
      {
        ...
        rating: "low",
        rationale:
          "Migrated from reviewed Proteus hint onr_proteus_065_networked-center.",
      },
    ],
    capabilities: [],
  },
  printings: [
    {
      ...
      printingId: "onr_proteus_065_networked-center",
      setId: "proteus",
      collectorNumber: "P065",
      rarity: "rare",
    },
  ],
  publication: {
