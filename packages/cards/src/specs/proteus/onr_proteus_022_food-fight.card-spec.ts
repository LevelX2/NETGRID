...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_022_food-fight"),
    title: "Food Fight",
    side: "corp",
    cardType: "ice",
  },
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_022_food-fight",
      },
    ],
  },
  engine: {
  ...
  planningAnnotations: {
    ...
    card: [
      ...
      },
      {
        ...
        confidence: "medium",
        rationale:
          "ICE Semantic Review v1: Food Fight bestätigt corp.ice_tax_glacier nur aus konkreten ICE-Funktionssignalen; Subtypen bleiben Kartendaten.",
      },
    ],
    capabilities: [],
  },
  printings: [
    {
      ...
      printingId: "onr_proteus_022_food-fight",
      setId: "proteus",
      collectorNumber: "P022",
      rarity: "common",
    },
  ],
  publication: {
