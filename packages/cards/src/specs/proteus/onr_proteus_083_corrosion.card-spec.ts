...
export const cardSpec = {
  ...
  identity: {
    cardDefinitionId: cardDefinitionId("onr_proteus_083_corrosion"),
    title: "Corrosion",
    side: "runner",
    cardType: "program",
  },
  ...
  rules: {
    ...
    references: [
      {
        source: "card_text",
        reference: "onr_proteus_083_corrosion",
      },
    ],
  },
  engine: {
  ...
  printings: [
    {
      ...
      printingId: "onr_proteus_083_corrosion",
      setId: "proteus",
      collectorNumber: "P083",
      rarity: "common",
    },
  ],
  publication: {
