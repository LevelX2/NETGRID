...
describe("benchmark report formatting", () => {
  ...
  it("runs and formats a small selfplay trace-mining smoke", () => {
    ...
    expect(report).toContain("- Decisions requiring WhyNot:");
    expect(report).toContain("- Decisions not requiring WhyNot:");
    ...
    expect(report).toContain("- Missing coverage signals:");
