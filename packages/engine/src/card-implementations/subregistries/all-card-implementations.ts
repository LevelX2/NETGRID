...
import { PROTEUS_RUNNER_HARDWARE_IMPLEMENTATIONS } from "./proteus-runner-hardware";
import { PROTEUS_RUNNER_PROGRAM_IMPLEMENTATIONS } from "./proteus-runner-programs";
import { PROTEUS_RUNNER_RESOURCE_IMPLEMENTATIONS } from "./proteus-runner-resources";

// Subregistries are catalog-only. They group declarative card files and must
// not execute abilities or add runtime conditions.
export const ALL_CARD_IMPLEMENTATIONS = [
