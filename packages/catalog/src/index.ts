...
const ONR_V1_9_19_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_19_RELEASE_CARD_IDS,
);
const ONR_V1_9_20_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_20_RELEASE_CARD_IDS,
);
const ONR_V1_0_6K_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_0_6K_RELEASE_CARD_IDS,
);
const ONR_V1_1_2K_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_1_2K_RELEASE_CARD_IDS,
);
const ONR_V1_2_3_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_2_3_RELEASE_CARD_IDS,
);
const ONR_V1_6_1_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_6_1_RELEASE_CARD_IDS,
);
const ONR_V1_6_2_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_6_2_RELEASE_CARD_IDS,
);
const ONR_V1_6_3_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_6_3_RELEASE_CARD_IDS,
);
const ONR_V1_7_0_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_7_0_RELEASE_CARD_IDS,
);
const ONR_V1_7_1_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_7_1_RELEASE_CARD_IDS,
);
const ONR_V1_7_2_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_7_2_RELEASE_CARD_IDS,
);
const ONR_V1_8_0_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_8_0_RELEASE_CARD_IDS,
);
const ONR_V1_8_1_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_8_1_RELEASE_CARD_IDS,
);
const ONR_V1_9_0_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_0_RELEASE_CARD_IDS,
);
const ONR_V1_9_1_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_1_RELEASE_CARD_IDS,
);
const ONR_V1_9_2_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_2_RELEASE_CARD_IDS,
);
const ONR_V1_9_3_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_3_RELEASE_CARD_IDS,
);
const ONR_V1_9_4_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_4_RELEASE_CARD_IDS,
);
const ONR_V1_9_5_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_5_RELEASE_CARD_IDS,
);
const ONR_V1_9_6_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_6_RELEASE_CARD_IDS,
);
const ONR_V1_9_7_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_7_RELEASE_CARD_IDS,
);
const ONR_V1_9_8_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_8_RELEASE_CARD_IDS,
);
const ONR_V1_9_9_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_9_RELEASE_CARD_IDS,
);
const ONR_V1_9_11_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_11_RELEASE_CARD_IDS,
);
const ONR_V1_9_12_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_12_RELEASE_CARD_IDS,
);
const ONR_V1_9_13_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_13_RELEASE_CARD_IDS,
);
const ONR_V1_9_14_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_14_RELEASE_CARD_IDS,
);
const ONR_V1_9_15_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_15_RELEASE_CARD_IDS,
);
const ONR_V1_9_16_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_16_RELEASE_CARD_IDS,
);
const ONR_V1_9_17_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_17_RELEASE_CARD_IDS,
);
const ONR_V1_9_18_RELEASE_CARD_ID_SET = new Set<string>(
  ONR_V1_9_18_RELEASE_CARD_IDS,
);
...
function applyOnrV105KReleaseGate(cards: CatalogCard[]): CatalogCard[] {
  return cards.map((card) =>
    ONR_V1_RUNTIME_RELEASE_CARD_ID_SET.has(card.catalogCardId)
...
function promoteOnrRuntimeReleaseCard(card: CatalogCard): CatalogCard {
  ...
  return {
    ...
    numeric: {
      ...card.numeric,
      ...(numericOverrides[card.catalogCardId] ?? {}),
    },
    statuses: {
      ...card.statuses,
      imported: true,
