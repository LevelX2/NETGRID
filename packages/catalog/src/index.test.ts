...
describe("catalog import and status logic", () => {
  ...
  it("applies the V1.0.5K through V1.9.8 release gates to private local O:NR runtime cards when present", () => {
    ...
    expect(ONR_V1_RUNTIME_RELEASE_CARD_IDS).not.toEqual(expect.arrayContaining([...ONR_V1_9_22_WIP_CARD_IDS]));
    ...
    expect(ONR_V1_RUNTIME_RELEASE_CARD_IDS).toEqual(expect.arrayContaining([...ONR_V1_9_17_RELEASE_CARD_IDS]));
    expect(ONR_V1_RUNTIME_RELEASE_CARD_IDS).toEqual(expect.arrayContaining([...ONR_V1_9_18_RELEASE_CARD_IDS]));
    expect(ONR_V1_RUNTIME_RELEASE_CARD_IDS).toEqual(expect.arrayContaining([...ONR_V1_9_19_RELEASE_CARD_IDS]));
    expect(ONR_V1_RUNTIME_RELEASE_CARD_IDS).toEqual(expect.arrayContaining([...ONR_V1_9_20_RELEASE_CARD_IDS]));
    expect(ONR_V1_RUNTIME_RELEASE_CARD_IDS).toEqual(expect.arrayContaining([...ONR_V1_9_21_RELEASE_CARD_IDS]));
    for (const cardId of ONR_V1_RUNTIME_RELEASE_CARD_IDS) {
      ...
      const expectedManifest = (ONR_V1_9_21_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ...
        : (ONR_V1_9_18_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.9.18"
        : (ONR_V1_9_17_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.9.17"
        : (ONR_V1_9_16_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.9.16"
        : (ONR_V1_9_15_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ...
        : (ONR_V1_9_12_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.9.12"
        : (ONR_V1_9_11_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.9.11"
        : (ONR_V1_9_9_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.9.9"
        : (ONR_V1_9_8_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ...
        : (ONR_V1_9_2_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.9.2"
        : (ONR_V1_9_1_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.9.1"
        : (ONR_V1_9_0_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.9.0"
        : (ONR_V1_8_1_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.8.1"
        : (ONR_V1_8_0_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.8.0"
        : (ONR_V1_7_2_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.7.2"
        : (ONR_V1_7_1_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
        ? "card-implementation-manifest-v1.7.1"
        : (ONR_V1_7_0_RELEASE_CARD_IDS as readonly string[]).includes(cardId)
    ...
    expect(cardsById["onr_v1_233_d-arc-knight"]?.text).toContain("Trash a program");
    ...
    expect(cardsById["onr_v1_084_edited-shipping-manifests"]?.numeric.cost).toBe(1);
    expect(cardsById["onr_v1_084_edited-shipping-manifests"]?.text).toContain("the Corp loses 1");
    expect(cardsById["onr_v1_106_private-ldl-access"]?.numeric.cost).toBe(0);
    expect(cardsById["onr_v1_106_private-ldl-access"]?.text).toContain("successful run on R&D");
    expect(cardsById["onr_v1_114_temple-microcode-outlet"]?.text).toContain("Search your stack for a program");
    expect(cardsById["onr_v1_118_weather-to-finance-pipe"]?.text).toContain("Corp loses 4 credits");
    expect(cardsById["onr_v1_129_hq-interface"]?.numeric.installCost).toBe(4);
    expect(cardsById["onr_v1_129_hq-interface"]?.implementationManifest?.manifestVersion).toBe("card-implementation-manifest-v1.7.1");
    expect(cardsById["onr_v1_158_danshis-second-id"]?.numeric.installCost).toBe(0);
    expect(cardsById["onr_v1_179_silicon-saloon-franchise"]?.text).toContain("Gain 1 credit and draw");
    expect(cardsById["onr_v1_283_audit-of-call-records"]?.text).toContain("Trace 5");
    expect(cardsById["onr_v1_284_chance-observation"]?.numeric.cost).toBe(2);
    expect(cardsById["onr_v1_286_corporate-detective-agency"]?.implementationManifest?.manifestVersion).toBe("card-implementation-manifest-v1.7.2");
    expect(cardsById["onr_v1_083_desperate-competitor"]?.text).toContain("Gray Ops agendas");
    ...
    expect(cardsById["onr_v1_159_databroker"]?.text).toContain("Gain 10 credits");
    expect(cardsById["onr_v1_201_executive-extraction"]?.implementationManifest?.manifestVersion).toBe("card-implementation-manifest-v1.8.0");
    expect(cardsById["onr_v1_214_project-babylon"]?.numeric.agendaPoints).toBe(1);
    expect(cardsById["onr_v1_012_clown"]?.numeric.installCost).toBe(4);
    expect(cardsById["onr_v1_046_pattels-virus"]?.text).toContain("Pattel counter");
    expect(cardsById["onr_v1_049_pox"]?.text).toContain("Pox counter");
    expect(cardsById["onr_v1_094_inside-job"]?.numeric.cost).toBe(2);
    expect(cardsById["onr_v1_173_restrictive-net-zoning"]?.numeric.installCost).toBe(1);
    expect(cardsById["onr_v1_193_corporate-coup"]?.implementationManifest?.manifestVersion).toBe("card-implementation-manifest-v1.8.1");
    expect(cardsById["onr_v1_209_political-coup"]?.numeric.advancementRequirement).toBe(4);
    ...
    expect(cardsById["onr_v1_242_fatal-attractor"]?.text).toContain("do 3 Net damage");
    ...
    expect(cardsById["onr_v1_030_grubb"]?.text).toContain("remainder of this run");
    expect(cardsById["onr_v1_013_cockroach"]?.implementationManifest?.manifestVersion).toBe("card-implementation-manifest-v1.9.1");
    expect(cardsById["onr_v1_076_all-nighter"]?.numeric.cost).toBe(0);
    expect(cardsById["onr_v1_096_kilroy-was-here"]?.text).toContain("run on R&D");
    expect(cardsById["onr_v1_107_romp-through-hq"]?.numeric.cost).toBe(2);
    expect(cardsById["onr_v1_184_top-runners-conference"]?.numeric.installCost).toBe(0);
    expect(cardsById["onr_v1_188_ai-chief-financial-officer"]?.numeric.advancementRequirement).toBe(5);
    expect(cardsById["onr_v1_211_polymer-breakthrough"]?.numeric.agendaPoints).toBe(3);
    ...
    expect(cardsById["onr_v1_271_tko-2-0"]?.text).toContain("forgoes his or her next action");
    expect(cardsById["onr_v1_251_jack-attack"]?.implementationManifest?.manifestVersion).toBe("card-implementation-manifest-v1.9.3");
    expect(cardsById["onr_v1_208_on-call-solo-team"]?.numeric.advancementRequirement).toBe(4);
    expect(cardsById["onr_v1_217_strike-force-kali"]?.numeric.agendaPoints).toBe(3);
    expect(cardsById["onr_v1_208_on-call-solo-team"]?.text).toContain("meat damage");
    expect(cardsById["onr_v1_217_strike-force-kali"]?.implementationManifest?.manifestVersion).toBe("card-implementation-manifest-v1.9.4");
  ...
  it("keeps V1.9.10 status consolidation to manifest and catalog parity without promotion", () => {
    ...
    const reconciledIds = ["onr_v1_243_fetch-4-0-1", "onr_v1_249_hunter", "onr_v1_306_trojan-horse"].sort();

    expect(v1910CardIds).toEqual(reconciledIds);
    expect(v1910Cards.every((card) => card.newlyPromotedInV1910 === false)).toBe(true);
    expect(v1910Cards.every((card) => card.implementationManifestRef === "data/manifests/card-implementation-manifest-1.2.3.json")).toBe(true);
    expect(v1910Cards.every((card) => card.aiApprovalManifestRef === "data/manifests/deck-legal-ai-approval-corp-tag-slice-manifest.json")).toBe(true);

    const v123ManifestCards = (cardImplementationManifest123Data.cards as Array<{ cardCode: string }>).map((card) => card.cardCode).sort();
    expect(v123ManifestCards).toEqual([...ONR_V1_2_3_RELEASE_CARD_IDS].sort());
    expect(cardImplementationManifest123Data.gateAssertions.currentRuntimePlayableCardCountIs11).toBe(true);
    expect(cardImplementationManifest123Data.v1910Reconciliation.noNewRuntimePromotion).toBe(true);
    ...
    expect(v1910RuntimeStatusReportData.counts.runtimeAiSupportedOnrCards).toBe(143);
    expect(v1910RuntimeStatusReportData.counts.notHumanPlayableDeckLegalAiSupported).toBe(231);
    expect(v1910RuntimeStatusReportData.noPromotionGate.newHumanPlayableCards).toEqual([]);
    expect(v1910RuntimeStatusReportData.noPromotionGate.newDeckLegalCards).toEqual([]);
    expect(v1910RuntimeStatusReportData.noPromotionGate.newAiSupportedCards).toEqual([]);

    const legacyCatalogIndexPath = "data/local/card-import/onr-v1-limited/catalog-index-onr-v1-limited.local.json";
    if (existsSync(legacyCatalogIndexPath)) {
      const legacyCatalogIndexText = readFileSync(legacyCatalogIndexPath, "utf8");
      expect(legacyCatalogIndexText).not.toContain("@@");
      expect(() => JSON.parse(legacyCatalogIndexText)).not.toThrow();
    } else {
      expect(v1910RuntimeStatusReportData.localCatalogIndex.statusInAutomationWorktree).toBe("absent_in_automation_worktree");
      expect(v1910RuntimeStatusReportData.localCatalogIndex.versionedFallback).toBe("data/reports/onr-v1-runtime-status-1.9.10.json");
    }

    expect((v1910StatusScenarioData.cards as string[]).sort()).toEqual(reconciledIds);
    expect(v1910NoPromotionAiHintsData.noPromotionGate.newAiSupportedCards).toEqual([]);
    expect((v1910NoPromotionAiHintsData.cards as Array<{ cardId: string; newlyPromotedInV1910: boolean }>).map((card) => card.cardId).sort()).toEqual(reconciledIds);
    expect((v1910NoPromotionAiHintsData.cards as Array<{ newlyPromotedInV1910: boolean }>).every((card) => card.newlyPromotedInV1910 === false)).toBe(true);
  ...
  it("approves the V1.7.1 to V1.8.1 open64 slice only after catalog, hint and scenario gates", () => {
    ...
    const approved = new Set<string>(DECK_LEGAL_AI_APPROVAL_V171_TO_V181_OPEN64_CARD_IDS);
    ...
    const manifestCards = deckLegalV171V181Open64ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const scenarioCards = new Set((deckLegalV171V181Open64ScenarioData.scenarios as Array<{ cards: string[] }>).flatMap((scenario) => scenario.cards));

    expect(DECK_LEGAL_AI_APPROVAL_V171_TO_V181_OPEN64_CARD_IDS).toHaveLength(28);
    expect(hints.map((hint) => hint.cardId).sort()).toEqual([...approved].sort());
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(deckLegalV171V181Open64ScenarioData.id).toBe("ai-deck-legal-v171-v181-open64-smokes");
    ...
    expect(JSON.stringify({ deckLegalV171V181Open64AiHintsData, deckLegalV171V181Open64ManifestData, deckLegalV171V181Open64ScenarioData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the legacy open64 slice only after catalog, hint and scenario gates", () => {
    ...
    const approved = new Set<string>(DECK_LEGAL_AI_APPROVAL_LEGACY_OPEN64_CARD_IDS);
    ...
    const manifestCards = deckLegalLegacyOpen64ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const scenarioCards = new Set((deckLegalLegacyOpen64ScenarioData.scenarios as Array<{ cards: string[] }>).flatMap((scenario) => scenario.cards));
    const supplementalIds = new Set((runtimeSupplementAiHintsData.cards as Array<{ cardId: string }>).map((hint) => hint.cardId));

    expect(DECK_LEGAL_AI_APPROVAL_LEGACY_OPEN64_CARD_IDS).toHaveLength(36);
    expect(hints.map((hint) => hint.cardId).sort()).toEqual([...approved].sort());
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(deckLegalLegacyOpen64ScenarioData.id).toBe("ai-deck-legal-legacy-open64-smokes");
    ...
    expect(JSON.stringify({ deckLegalLegacyOpen64AiHintsData, deckLegalLegacyOpen64ManifestData, deckLegalLegacyOpen64ScenarioData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the V1.9.0 release slice only after catalog, hint and scenario gates", () => {
    ...
    const manifestCards = deckLegalV190ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const scenarioCards = new Set((deckLegalV190ScenarioData.scenarios as Array<{ cards: string[] }>).flatMap((scenario) => scenario.cards));
    ...
    expect(JSON.stringify({ deckLegalV190AiHintsData, deckLegalV190ManifestData, deckLegalV190ScenarioData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the V1.9.1 to V1.9.4 release slice only after catalog, hint and scenario gates", () => {
    ...
    const approved = new Set<string>(DECK_LEGAL_AI_APPROVAL_V191_TO_V194_CARD_IDS);
    ...
    const manifestCards = deckLegalV191V194ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const scenarioCards = new Set((deckLegalV191V194ScenarioData.scenarios as Array<{ cards: string[] }>).flatMap((scenario) => scenario.cards));

    expect(DECK_LEGAL_AI_APPROVAL_V191_TO_V194_CARD_IDS).toHaveLength(16);
    expect(hints.map((hint) => hint.cardId).sort()).toEqual([...approved].sort());
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(deckLegalV191V194ScenarioData.id).toBe("ai-deck-legal-v191-v194-smokes");
    ...
    expect(JSON.stringify({ deckLegalV191V194AiHintsData, deckLegalV191V194ManifestData, deckLegalV191V194ScenarioData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the V1.9.5 to V1.9.8 release slice only after catalog, hint and scenario gates", () => {
    ...
    const approved = new Set<string>(DECK_LEGAL_AI_APPROVAL_V195_TO_V198_CARD_IDS);
    ...
    const manifestCards = deckLegalV195V198ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const scenarioCards = new Set((deckLegalV195V198ScenarioData.scenarios as Array<{ cards: string[] }>).flatMap((scenario) => scenario.cards));

    expect(DECK_LEGAL_AI_APPROVAL_V195_TO_V198_CARD_IDS).toHaveLength(6);
    expect(hints.map((hint) => hint.cardId).sort()).toEqual([...approved].sort());
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(deckLegalV195V198ScenarioData.id).toBe("ai-deck-legal-v195-v198-smokes");
    ...
    expect(JSON.stringify({ deckLegalV195V198AiHintsData, deckLegalV195V198ManifestData, deckLegalV195V198ScenarioData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the V1.9.9 upgrade slice only after catalog, hint and scenario gates", () => {
    ...
    const manifestCards = deckLegalV199ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const scenarioCards = new Set((deckLegalV199ScenarioData.scenarios as Array<{ cards: string[] }>).flatMap((scenario) => scenario.cards));
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V199_CARD_IDS) {
      ...
      expect(card?.statuses.format_legal, cardId).toBe(true);
      expect(card?.statuses.ai_supported, cardId).toBe(true);
      expect(card?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.9");
      expect(hint?.aiSupportStatus, cardId).toBe("ai_supported");
      expect(hint?.roles.length, cardId).toBeGreaterThan(0);
      expect(hint?.planRoles.length, cardId).toBeGreaterThan(0);
      expect(hint?.requiredMechanics.length, cardId).toBeGreaterThan(0);
    ...
    expect(JSON.stringify({ deckLegalV199AiHintsData, deckLegalV199ManifestData, deckLegalV199ScenarioData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the V1.9.11 hidden-zone slice only after catalog, manifest, hint and scenario gates", () => {
    ...
    const manifestCards = deckLegalV1911ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const implementationCards = cardImplementationManifest1911Data.cards as Array<{ cardCode: string; releaseStatus: string; aiSupported: boolean; resolverFamily: string }>;
    const scenarioCards = new Set((deckLegalV1911ScenarioData.scenarios as Array<{ cards: string[] }>).flatMap((scenario) => scenario.cards));
    ...
    expect(v1911ReleaseScenarioData.additionalCards.sort()).toEqual([...approved].sort());
    expect(v1911MechanicsCoverageData.gateAssertions.hiddenZoneSearchRevealReorderResolverImplemented).toBe(true);
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V1911_CARD_IDS) {
      ...
      expect(card?.statuses.format_legal, cardId).toBe(true);
      expect(card?.statuses.ai_supported, cardId).toBe(true);
      expect(card?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.11");
      expect(hint?.aiSupportStatus, cardId).toBe("ai_supported");
      expect(hint?.roles.length, cardId).toBeGreaterThan(0);
      expect(hint?.planRoles.length, cardId).toBeGreaterThan(0);
      expect(hint?.requiredMechanics.length, cardId).toBeGreaterThan(0);
  ...
  it("approves the V1.9.12 counter/recurring slice only after catalog, manifest, hint and scenario gates", () => {
    ...
    const manifestCards = deckLegalV1912ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    ...
    expect(ONR_V1_RUNTIME_RELEASE_CARD_IDS).toEqual(expect.arrayContaining([...ONR_V1_9_12_RELEASE_CARD_IDS]));
    expect(hints.map((hint) => hint.cardId).sort()).toEqual([...approved].sort());
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(implementationCards.map((card) => card.cardCode).sort()).toEqual([...approved].sort());
    expect(v1912WipScenarioData.coversCards.sort()).toEqual([...approved].sort());
    expect([...scenarioCards].sort()).toEqual([...approved].sort());
    expect(cardImplementationManifest1912Data.gateAssertions.allCardsHumanPlayable).toBe(true);
    expect(cardImplementationManifest1912Data.gateAssertions.allCardsDeckLegal).toBe(true);
    expect(cardImplementationManifest1912Data.gateAssertions.allCardsAiSupported).toBe(true);
    expect(deckLegalV1912ScenarioData.completionGate.aiSupported).toBe(true);
    expect(v1912MechanicsCoverageData.gateAssertions.typedCounterVirusPurgeResolverImplemented).toBe(true);
    expect(v1912MechanicsCoverageData.gateAssertions.recurringPoolStartTurnResolverImplemented).toBe(true);
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V1912_CARD_IDS) {
      ...
      expect(runtimeCard?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.12");
      expect(hint?.aiSupportStatus, cardId).toBe("ai_supported");
      expect(hint?.roles.length, cardId).toBeGreaterThan(0);
      expect(hint?.planRoles.length, cardId).toBeGreaterThan(0);
      expect(hint?.requiredMechanics.length, cardId).toBeGreaterThan(0);
  ...
  it("approves the V1.9.13 damage/prevention slice only after catalog, manifest, hint and scenario gates", () => {
    ...
    const manifestCards = deckLegalV1913ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const implementationCards = cardImplementationManifest1913Data.cards as Array<{ cardCode: string; releaseStatus: string; aiSupported: boolean; resolverFamily: string }>;
    const scenarioCards = new Set((deckLegalV1913ScenarioData.scenarios as Array<{ coversCards: string[] }>).flatMap((scenario) => scenario.coversCards));
    ...
    expect(ONR_V1_RUNTIME_RELEASE_CARD_IDS).toEqual(expect.arrayContaining([...ONR_V1_9_13_RELEASE_CARD_IDS]));
    expect(hints.map((hint) => hint.cardId).sort()).toEqual([...approved].sort());
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(implementationCards.map((card) => card.cardCode).sort()).toEqual([...approved].sort());
    expect(v1913ReleaseScenarioData.coversCards.sort()).toEqual([...approved].sort());
    expect([...scenarioCards].sort()).toEqual([...approved].sort());
    expect(cardImplementationManifest1913Data.gateAssertions.allCardsHumanPlayable).toBe(true);
    expect(cardImplementationManifest1913Data.gateAssertions.allCardsDeckLegal).toBe(true);
    expect(cardImplementationManifest1913Data.gateAssertions.allCardsAiSupported).toBe(true);
    expect(deckLegalV1913ScenarioData.completionGate.aiSupported).toBe(true);
    expect(v1913MechanicsCoverageData.gateAssertions.eventModificationPreventionAvoidResolverImplemented).toBe(true);
    expect(v1913MechanicsCoverageData.gateAssertions.damageEventPreventionResolverImplemented).toBe(true);
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V1913_CARD_IDS) {
      ...
      expect(runtimeCard?.statuses.format_legal, cardId).toBe(true);
      expect(runtimeCard?.statuses.ai_supported, cardId).toBe(true);
      expect(runtimeCard?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.13");
      expect(hint?.aiSupportStatus, cardId).toBe("ai_supported");
      expect(hint?.roles.length, cardId).toBeGreaterThan(0);
      expect(hint?.planRoles.length, cardId).toBeGreaterThan(0);
      expect(hint?.requiredMechanics.length, cardId).toBeGreaterThan(0);
    ...
    expect(JSON.stringify({ deckLegalV1913AiHintsData, deckLegalV1913ManifestData, deckLegalV1913ScenarioData, v1913ReleaseScenarioData, v1913MechanicsCoverageData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the V1.9.14 trace/tag/resource slice only after catalog, manifest, hint and scenario gates", () => {
    ...
    const manifestCards = deckLegalV1914ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const implementationCards = cardImplementationManifest1914Data.cards as Array<{ cardCode: string; releaseStatus: string; aiSupported: boolean; resolverFamily: string }>;
    const scenarioCards = new Set((deckLegalV1914ScenarioData.scenarios as Array<{ coversCards: string[] }>).flatMap((scenario) => scenario.coversCards));
    ...
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(implementationCards.map((card) => card.cardCode).sort()).toEqual([...approved].sort());
    expect(v1914ReleaseScenarioData.coversCards.sort()).toEqual([...approved].sort());
    expect([...scenarioCards].sort()).toEqual([...approved].sort());
    expect(cardImplementationManifest1914Data.gateAssertions.allCardsHumanPlayable).toBe(true);
    expect(cardImplementationManifest1914Data.gateAssertions.allCardsDeckLegal).toBe(true);
    expect(cardImplementationManifest1914Data.gateAssertions.allCardsAiSupported).toBe(true);
    expect(deckLegalV1914ScenarioData.completionGate.aiSupported).toBe(true);
    expect(v1914MechanicsCoverageData.gateAssertions.traceLinkBidWindowResolverImplemented).toBe(true);
    expect(v1914MechanicsCoverageData.gateAssertions.resourceTagInteractionResolverImplemented).toBe(true);
    expect(v1914MechanicsCoverageData.gateAssertions.tagConditionAvoidRemoveResolverImplemented).toBe(true);
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V1914_CARD_IDS) {
      ...
      expect(runtimeCard?.statuses.format_legal, cardId).toBe(true);
      expect(runtimeCard?.statuses.ai_supported, cardId).toBe(true);
      expect(runtimeCard?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.14");
  ...
  it("approves the V1.9.16 program subtype, hosting and stealth slice after full gates", () => {
    ...
    const manifestCards = deckLegalV1916ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const implementationCards = cardImplementationManifest1916Data.cards as Array<{ cardCode: string; releaseStatus: string; aiSupported: boolean; resolverFamily: string }>;
    const scenarioCards = new Set((deckLegalV1916ScenarioData.scenarios as Array<{ coversCards: string[] }>).flatMap((scenario) => scenario.coversCards));
    ...
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(implementationCards.map((card) => card.cardCode).sort()).toEqual([...approved].sort());
    expect(v1916ReleaseScenarioData.coversCards.sort()).toEqual([...approved].sort());
    expect([...scenarioCards].sort()).toEqual([...approved].sort());
    expect(cardImplementationManifest1916Data.gateAssertions.allCardsHumanPlayable).toBe(true);
    expect(cardImplementationManifest1916Data.gateAssertions.allCardsDeckLegal).toBe(true);
    expect(cardImplementationManifest1916Data.gateAssertions.allCardsAiSupported).toBe(true);
    expect(deckLegalV1916ScenarioData.completionGate.aiSupported).toBe(true);
    expect(v1916MechanicsCoverageData.gateAssertions.hostingLifecycleCovered).toBe(true);
    expect(v1916MechanicsCoverageData.gateAssertions.aiChoicePathsCovered).toBe(true);
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V1916_CARD_IDS) {
      ...
      expect(runtimeCard?.statuses.format_legal, cardId).toBe(true);
      expect(runtimeCard?.statuses.ai_supported, cardId).toBe(true);
      expect(runtimeCard?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.16");
      expect(runtimeCard?.text, cardId).not.toContain("WIP");
      expect(hint?.aiSupportStatus, cardId).toBe("ai_supported");
      expect(hint?.roles.length, cardId).toBeGreaterThan(0);
      expect(hint?.planRoles.length, cardId).toBeGreaterThan(0);
  ...
  it("approves the V1.9.17 generic asset node slice after full gates", () => {
    ...
    const manifestCards = deckLegalV1917ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const implementationCards = cardImplementationManifest1917Data.cards as Array<{ cardCode: string; releaseStatus: string; aiSupported: boolean; resolverFamily: string }>;
    const scenarioCards = new Set((deckLegalV1917ScenarioData.scenarios as Array<{ coversCards: string[] }>).flatMap((scenario) => scenario.coversCards));
    ...
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(implementationCards.map((card) => card.cardCode).sort()).toEqual([...approved].sort());
    expect(v1917ReleaseScenarioData.coversCards.sort()).toEqual([...approved].sort());
    expect([...scenarioCards].sort()).toEqual([...approved].sort());
    expect(cardImplementationManifest1917Data.gateAssertions.allCardsHumanPlayable).toBe(true);
    expect(cardImplementationManifest1917Data.gateAssertions.allCardsDeckLegal).toBe(true);
    expect(cardImplementationManifest1917Data.gateAssertions.allCardsAiSupported).toBe(true);
    expect(deckLegalV1917ScenarioData.completionGate.aiSupported).toBe(true);
    expect(v1917MechanicsCoverageData.gateAssertions.genericAssetNodeResolverCovered).toBe(true);
    expect(v1917MechanicsCoverageData.gateAssertions.installedCardTargetingCovered).toBe(true);
    expect(v1917MechanicsCoverageData.gateAssertions.virusCounterTargetingCovered).toBe(true);
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V1917_CARD_IDS) {
      ...
      expect(runtimeCard?.statuses.format_legal, cardId).toBe(true);
      expect(runtimeCard?.statuses.ai_supported, cardId).toBe(true);
      expect(runtimeCard?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.17");
      expect(runtimeCard?.text, cardId).not.toContain("WIP");
      expect(hint?.aiSupportStatus, cardId).toBe("ai_supported");
      expect(hint?.roles.length, cardId).toBeGreaterThan(0);
      expect(hint?.planRoles.length, cardId).toBeGreaterThan(0);
    ...
    expect(JSON.stringify({ deckLegalV1917AiHintsData, deckLegalV1917ManifestData, deckLegalV1917ScenarioData, v1917ReleaseScenarioData, v1917MechanicsCoverageData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the V1.9.18 generic upgrade root server slice after full gates", () => {
    ...
    const manifestCards = deckLegalV1918ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const implementationCards = cardImplementationManifest1918Data.cards as Array<{ cardCode: string; releaseStatus: string; aiSupported: boolean; resolverFamily: string }>;
    const scenarioCards = new Set((deckLegalV1918ScenarioData.scenarios as Array<{ coversCards: string[] }>).flatMap((scenario) => scenario.coversCards));
    ...
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(implementationCards.map((card) => card.cardCode).sort()).toEqual([...approved].sort());
    expect(v1918ReleaseScenarioData.coversCards.sort()).toEqual([...approved].sort());
    expect([...scenarioCards].sort()).toEqual([...approved].sort());
    expect(cardImplementationManifest1918Data.gateAssertions.allCardsHumanPlayable).toBe(true);
    expect(cardImplementationManifest1918Data.gateAssertions.allCardsDeckLegal).toBe(true);
    expect(cardImplementationManifest1918Data.gateAssertions.allCardsAiSupported).toBe(true);
    expect(deckLegalV1918ScenarioData.completionGate.aiSupported).toBe(true);
    expect(v1918MechanicsCoverageData.gateAssertions.genericUpgradeRootServerResolverCovered).toBe(true);
    expect(v1918MechanicsCoverageData.gateAssertions.runStartTaxCovered).toBe(true);
    expect(v1918MechanicsCoverageData.gateAssertions.tagConditionCreditCovered).toBe(true);
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V1918_CARD_IDS) {
      ...
      expect(runtimeCard?.statuses.format_legal, cardId).toBe(true);
      expect(runtimeCard?.statuses.ai_supported, cardId).toBe(true);
      expect(runtimeCard?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.18");
      expect(runtimeCard?.text, cardId).not.toContain("WIP");
      expect(hint?.aiSupportStatus, cardId).toBe("ai_supported");
      expect(hint?.roles.length, cardId).toBeGreaterThan(0);
      expect(hint?.planRoles.length, cardId).toBeGreaterThan(0);
    ...
    expect(JSON.stringify({ deckLegalV1918AiHintsData, deckLegalV1918ManifestData, deckLegalV1918ScenarioData, v1918ReleaseScenarioData, v1918MechanicsCoverageData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the V1.9.19 agenda overadvance slice after full gates", () => {
    ...
    const manifestCards = deckLegalV1919ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const implementationCards = cardImplementationManifest1919Data.cards as Array<{ cardCode: string; releaseStatus: string; aiSupported: boolean; resolverFamily: string }>;
    const scenarioCards = new Set((deckLegalV1919ScenarioData.scenarios as Array<{ coversCards: string[] }>).flatMap((scenario) => scenario.coversCards));
    ...
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(implementationCards.map((card) => card.cardCode).sort()).toEqual([...approved].sort());
    expect(v1919ReleaseScenarioData.coversCards.sort()).toEqual([...approved].sort());
    expect([...scenarioCards].sort()).toEqual([...approved].sort());
    expect(cardImplementationManifest1919Data.gateAssertions.allCardsHumanPlayable).toBe(true);
    expect(cardImplementationManifest1919Data.gateAssertions.allCardsDeckLegal).toBe(true);
    expect(cardImplementationManifest1919Data.gateAssertions.allCardsAiSupported).toBe(true);
    expect(deckLegalV1919ScenarioData.completionGate.aiSupported).toBe(true);
    expect(v1919MechanicsCoverageData.gateAssertions.scoredAgendaResolverCovered).toBe(true);
    expect(v1919MechanicsCoverageData.gateAssertions.agendaDifficultyOveradvanceCovered).toBe(true);
    expect(v1919MechanicsCoverageData.gateAssertions.runnerAgendaCostEdgesCovered).toBe(true);
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V1919_CARD_IDS) {
      ...
      expect(runtimeCard?.statuses.format_legal, cardId).toBe(true);
      expect(runtimeCard?.statuses.ai_supported, cardId).toBe(true);
      expect(runtimeCard?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.19");
      expect(runtimeCard?.text, cardId).not.toContain("WIP");
      expect(hint?.aiSupportStatus, cardId).toBe("ai_supported");
      expect(hint?.roles.length, cardId).toBeGreaterThan(0);
      expect(hint?.planRoles.length, cardId).toBeGreaterThan(0);
    ...
    expect(JSON.stringify({ deckLegalV1919AiHintsData, deckLegalV1919ManifestData, deckLegalV1919ScenarioData, v1919ReleaseScenarioData, v1919MechanicsCoverageData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the V1.9.20 global modifier and special-state slice after full gates", () => {
    ...
    const manifestCards = deckLegalV1920ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const implementationCards = cardImplementationManifest1920Data.cards as Array<{ cardCode: string; releaseStatus: string; aiSupported: boolean; resolverFamily: string }>;
    const scenarioCards = new Set((deckLegalV1920ScenarioData.scenarios as Array<{ coversCards: string[] }>).flatMap((scenario) => scenario.coversCards));
    ...
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(implementationCards.map((card) => card.cardCode).sort()).toEqual([...approved].sort());
    expect(v1920ReleaseScenarioData.coversCards.sort()).toEqual([...approved].sort());
    expect([...scenarioCards].sort()).toEqual([...approved].sort());
    expect(cardImplementationManifest1920Data.gateAssertions.allCardsHumanPlayable).toBe(true);
    expect(cardImplementationManifest1920Data.gateAssertions.allCardsDeckLegal).toBe(true);
    expect(cardImplementationManifest1920Data.gateAssertions.allCardsAiSupported).toBe(true);
    ...
    expect(v1920MechanicsCoverageData.gateAssertions.hiddenInfoSafeForCoveredSmokes).toBe(true);
    expect(v1920MechanicsCoverageData.gateAssertions.catalogPromotionPending).toBe(false);
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V1920_CARD_IDS) {
      ...
      expect(runtimeCard?.statuses.format_legal, cardId).toBe(true);
      expect(runtimeCard?.statuses.ai_supported, cardId).toBe(true);
      expect(runtimeCard?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.20");
      expect(runtimeCard?.text, cardId).not.toContain("WIP");
      expect(hint?.aiSupportStatus, cardId).toBe("ai_supported");
      expect(hint?.roles.length, cardId).toBeGreaterThan(0);
      expect(hint?.planRoles.length, cardId).toBeGreaterThan(0);
    ...
    expect(JSON.stringify({ deckLegalV1920AiHintsData, deckLegalV1920ManifestData, deckLegalV1920ScenarioData, v1920ReleaseScenarioData, v1920MechanicsCoverageData })).not.toMatch(
      /"cardInstances"\s*:|"privatePayload"\s*:|"sessionToken"\s*:|"reconnectToken"\s*:|"joinToken"\s*:|"tokenHash"\s*:|"fullState"\s*:|[A-Za-z]:\\/
    );
  });
  ...
  it("approves the V1.9.21 deterministic random slice after full gates", () => {
    ...
    const manifestCards = deckLegalV1921ManifestData.cards as Array<{ cardId: string; status: string; scenarioRefs: string[] }>;
    const implementationCards = cardImplementationManifest1921Data.cards as Array<{ cardCode: string; releaseStatus: string; aiSupported: boolean; resolverFamily: string }>;
    const scenarioCards = new Set((deckLegalV1921ScenarioData.scenarios as Array<{ coversCards: string[] }>).flatMap((scenario) => scenario.coversCards));
    ...
    expect(manifestCards.map((card) => card.cardId).sort()).toEqual([...approved].sort());
    expect(implementationCards.map((card) => card.cardCode).sort()).toEqual([...approved].sort());
    expect(v1921ReleaseScenarioData.coversCards.sort()).toEqual([...approved].sort());
    expect([...scenarioCards].sort()).toEqual([...approved].sort());
    expect(cardImplementationManifest1921Data.gateAssertions.allCardsHumanPlayable).toBe(true);
    ...
    for (const cardId of DECK_LEGAL_AI_APPROVAL_V1921_CARD_IDS) {
      ...
      expect(runtimeCard?.statuses.format_legal, cardId).toBe(true);
      expect(runtimeCard?.statuses.ai_supported, cardId).toBe(true);
      expect(runtimeCard?.implementationManifest?.manifestVersion, cardId).toBe("card-implementation-manifest-v1.9.21");
      expect(runtimeCard?.text, cardId).not.toContain("WIP");
      expect(hint?.aiSupportStatus, cardId).toBe("ai_supported");
      expect(hint?.requiredMechanics, cardId).toContain("deterministic_random_card_resolver");
      expect(hint?.roles.length, cardId).toBeGreaterThan(0);
      expect(hint?.planRoles.length, cardId).toBeGreaterThan(0);
      expect(hint?.scenarioRefs.length, cardId).toBeGreaterThan(0);
      expect(manifest?.status, cardId).toBe("ai_supported");
      ...
      expect(implementation?.releaseStatus, cardId).toBe("human_playable");
      expect(implementation?.aiSupported, cardId).toBe(true);
      expect(implementation?.resolverFamily, cardId).toContain("deterministic_random_card_resolver");
      expect(scenarioCards.has(cardId), cardId).toBe(true);
    }
  ...
  it("keeps the V1.9.22 longtail WIP artifacts aligned without catalog or AI promotion", () => {
    ...
    const corpOperationResolverCards = manifestCards.filter((card) =>
      ["v1922_corp_operation_install_action_bundle", "v1922_corp_operation_private_archives_to_hq", "v1922_corp_operation_private_rd_top5_reorder"].includes(card.resolverFamily)
    );
    ...
    expect(corpOperationResolverCards.map((card) => card.cardCode).sort()).toEqual([
    ...
    expect(plannedCards).toHaveLength(20);
