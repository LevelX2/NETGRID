...
- Der nächste empfohlene Scope ist V0.97 Requirements Freeze für Run, Jack-out, Breach und Multiaccess. M2 kann später aus `docs/derived/SETUP_GAME_END_0.93_SPEC.md` starten. Jack-out, Breach, Multiaccess, Identity-Abilities, Hidden-Zone-Tools, Hosting, Viren, Counter-Familien und Prevention sind weiterhin nicht spielbar, bis das jeweilige Gate umgesetzt ist.
...
- V0.92, V0.93, V0.94, V0.95 und V0.96 sind abgeschlossen. Damage/Flatline, Resources und Trace/Link/Bidding sind nur in ihren engen Gates spielbar. Mulligan, Jack-out, Breach, Multiaccess, Identity-Abilities, Hidden-Zone-Tools, Hosting, Viren, Counter-Familien und Prevention bleiben weiterhin nicht spielbar, bis das jeweilige Gate umgesetzt ist.
