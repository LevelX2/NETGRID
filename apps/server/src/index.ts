  ...
  const decision = chooseCorpAction(
    buildAiDecisionInput(state, "corp", {
      ...
      expectedDeckSnapshot: {
        ...
        cardPoolSnapshotId:
          state.deckMetadata?.corp.cardPoolSnapshotId ??
          LOCAL_DEMO_DECK_SETUP.corpSnapshot.cardPoolSnapshotId,
        formatProfileId:
          state.deckMetadata?.corp.formatProfileId ??
          LOCAL_DEMO_DECK_SETUP.corpSnapshot.formatProfileId,
        deckHash:
          state.deckMetadata?.corp.deckHash ??
          LOCAL_DEMO_DECK_SETUP.corpSnapshot.deckHash,
      },
    }),
    {
