...
internal static class UpdateTransaction
{
    ...
    private static void RequireProductAbsent(string programRoot)
    {
        if (ProductProcesses.Remain(programRoot)) throw new InvalidOperationException("updater_product_processes_remain");
    }
