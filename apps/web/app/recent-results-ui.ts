...
export function singleRecentMatchPoints(
  winner: ApiRecentGameResult["winner"],
  side: Side,
  agendaPoints: number,
): number {
...
export function seriesStatusLabel(
  status: ApiRecentSeriesResult["status"],
): string {
...
export function recentSeriesWinnerLabel(
  result: Pick<ApiRecentSeriesResult, "outcome" | "players">,
): string {
