...
if (
  !["META1_done", "integration_preflight", "merged_to_main", "worktree_removed", "complete"].includes(
    progress.currentStep,
  )
) {
  fail("progress currentStep must be META1_done or a later integration state");
}
