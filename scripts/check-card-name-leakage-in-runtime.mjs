...
const abstractionPlan = [
  ...
  },
  {
    ...
    notes:
      "Access-/Breach-State ist generisch ueber Run-Duration-Effects und Delayed-Access-Effects umgesetzt; die Quelle bleibt ueber sourceDefinitionId/sourceCardInstanceId nachvollziehbar.",
  },
  {
    priority: "slice_done",
