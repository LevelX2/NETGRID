...
Der Derived-Guard erzeugt 1317 Tokens aus Kartentiteln und `cardDefinitionId`-Varianten und hält 143 problemzonenrelevante Fingerprints als Baseline.
...
| new_unclassified_card_name_leak | 134 |
