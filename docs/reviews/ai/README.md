...
- `aufgabe-005-batch1-normalization-dry-run-2026-05-25.md` / `aufgabe-005-batch1-normalization-dry-run-report-2026-05-25.json`: Aufgabe 005 normalisiert die sieben Batch-1-Shape-Differences read-only im Comparator-Pfad und hält den Employee-Empowerment-Deriver-Follow-up separat sichtbar.
