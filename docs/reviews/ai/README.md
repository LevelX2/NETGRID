...
- `ai-compiled-index-warning-classification-2026-05-25.md`: fachliche Klassifikation der 80 verbleibenden Compiled-Index-Warnings in Monolith-Duplikation, Generated-Fact-Abweichung, Overlay-only-Strategie, Info-Anteile und einen fokussierten Review-Kandidaten ohne aktive Hintmigration.
