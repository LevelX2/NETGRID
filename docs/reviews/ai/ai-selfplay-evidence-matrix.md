...
| `runner-cost-penalty-support-continuation` | Eine planseitig gewählte Runner-Action nach freiwilligem Engine-Zahlungssupport mit identischer Action-, Fenster- und Planherkunft fortsetzen                     |     1 |        0 |         0 |                   1 | Weitere Kosten- und Strafzahlungsquellen prüfen; Support darf nur die exakte aktuelle Originalaction fortsetzen und keine eigene Strategieentscheidung treffen                        |
...
| `structured-choice-origin-binding`        | Jedes planrelevante Engine-Choice strukturiert an Quellinstanz, Quelldefinition und ausgewählte Aktion zurückbinden                                              |     5 |        0 |         0 |                   5 | Weitere Hidden-Zone-, Search- und mehrstufige Rez-/Install-Choices auf vollständige strukturierte Herkunft prüfen; Source-Strings bleiben ungeparst                                    |
...
| `deterministic-ai-replay-identity`        | Fachlich gleiche KI-Zustände über verschiedene Match-IDs in dieselbe RNG-, Plan- und Tie-Break-Folge überführen                                                  |     1 |        0 |         0 |                   1 | Weitere Engine-Randomisierungsfamilien und Planner-Fingerprints auf Transport-, Zeit- und Auditidentitäten prüfen                                                                     |
| `runner-central-payoff-owner-binding`     | Sichtbare zentrale Payoff-Karten auch ohne nachgelagerte Kandidatenanreicherung beim bestehenden Zentraldruckowner halten                                        |     1 |        0 |         0 |                   1 | Weitere Central-Payoff-Quellen über Quellinstanz, Definition-Hint und unveränderte Ownergrenze prüfen                                                                                  |
| `corp-rule-score-conversion`              | Engine-gequotete Regelaktionen mit unmittelbarem Agendapunktgewinn beim bestehenden Scoreowner materialisieren                                                   |     1 |        0 |         0 |                   1 | Weitere regelbasierte Scorekonversionen nur über positive Engine-Quote und exakte LegalAction anbinden                                                                                |
| `corp-punish-route-quote-completeness`    | Mehrstufige Tag-/Trace-/Damage-Linien vollständig quoten und nach Verlust der Score-Siegroute rechtzeitig in ausführbare Punish-Planung wechseln                   |     2 |        2 |         0 |                   0 | Weitere Flatline-Paarungen sowie Chance-Observation/Scorched-Earth-Zustände mit vollständig persistiertem Routegrund und konkret dominanter früherer Reserveentscheidung sammeln       |
...
| `runner-terminal-contest-risk-contract`   | Einen begonnenen Contest gegen den sicheren Matchverlust im unmittelbar folgenden Corp-Zug bewerten, statt ihn weiter nur als unverbindliche Probe zu behandeln  |     1 |        1 |         0 |                   0 | Weitere Next-Turn-Scorezustände oder eine side-sichere generische Terminalquote sammeln; keine Sonderregel für eine bestimmte Agenda                                                  |
...
| `runner-visible-damage-survival`          | Öffentlich sichtbaren, nicht bezahlbar brechbaren ICE-Schaden einschließlich Action-Handkosten und Cleanup-Flatline vor Runstart und im Jack-out-Fenster erkennen |     3 |        0 |         0 |                   3 | Weitere Damage-Typen, kombinierte Prävention, Run-Action-Kosten und mehrere verbleibende ICE mit derselben Engine-Quote prüfen                                                        |
| `runner-run-window-plan-coverage`         | Jede exakt admissible Encounter-/Runfensteraktion samt kanonischer Quellfähigkeit im zuständigen Runfensterplan halten, ohne Ziel- oder Aktionswahl an einen Resolver abzugeben |     4 |        0 |         0 |                   4 | Weitere flexible Modus-, Deflect-, Pump-/Break-, CardSpec- und Continue-Kombinationen mit unverändertem Root, Leaf, Step und Executor prüfen                                           |
...
| `ai-failure-attempt-observability`        | Fail-closed Input-/Choose-/Apply-Fehlversuche privat vollständig und öffentlich side-sicher persistieren                                                         |     2 |        0 |         0 |                   2 | Neue Laufzeitabbrüche müssen Phase, Checkpoint, Actionbindung und strukturierten Fehler ohne Stacktrace enthalten                                                                      |
| `runner-visible-card-mode`                | Actor-sichtbare aktuelle Kartenmodi und Subtypen vollständig in den KI-Input projizieren, ohne verdeckte Auswahlfelder offenzulegen                               |     1 |        0 |         0 |                   1 | Weitere dynamische Modusfamilien zwischen Engine, PlayerView, AI-DTO und Runpfad vergleichen                                                                                           |
| `runner-central-pressure-conversion`      | Angesammelten öffentlich belegten Zentraldruck rechtzeitig in eine konkrete kostenlose oder sofort wirksame Aktion umwandeln                                     |     1 |        0 |         0 |                   1 | Weitere persistente Druckressourcen auf Action-Wirkung, aktuelle Priorität und unveränderte Central-Ownership prüfen                                                                   |
| `engine-terminal-access-continuation`     | Nach einem terminalen Zugriffseffekt keine nachgelagerten Access-Belohnungen oder Zustandsänderungen mehr ausführen                                               |     1 |        0 |         0 |                   1 | Weitere tödliche Access-, Damage- und Agendaeffekte mit verzögerten Fortsetzungen prüfen                                                                                               |
| `runner-known-remote-risk-memory`         | Bekannte Remote-Kosten, Schäden und Identität über Folgezugriffe bewahren und nicht erneut als unbekannte Informationsfrage behandeln                            |     2 |        0 |         0 |                   2 | Weitere Positionswechsel, mehrere verdeckte Karten und geänderte bekannte Serverinhalte prüfen                                                                                        |
| `runner-campaign-target-continuity`       | Eine laufende Kampagne nur nach einer echten, exakt zielgebundenen Zustandsänderung als beendet klassifizieren                                                    |     1 |        0 |         0 |                   1 | Weitere Ablehnungs-, Trash- und Move-Fenster auf exakte Zielinstanz und unveränderte Kampagnenownership prüfen                                                                         |
...
| `SP-068` | `runner-run-window-plan-coverage`         | Behoben/verifiziert | Runner | Zyklus 014, finale Drei-Seed-Serie                                                                                                                  | Eine kostenlose Bulldozer-Folgeaktion verlor die kanonische Fähigkeit, die sie erzeugt hatte, und konnte im Runplan nicht sicher gebunden werden                                                                                                                       | Engine bewahrt die exakte Quellfähigkeit; `runner.convert_run_window` bleibt alleiniger Runfensterowner                                                               |
| `SP-069` | `ai-failure-attempt-observability`        | Behoben/verifiziert | Beide  | Zyklus 014, fokussierter Server-Inputfehler                                                                                                        | Ein Fehler beim Aufbau des KI-Inputs verließ den Pfad vor der strukturierten Failure-Persistenz und verlor damit die reproduzierbare Diagnose                                                                                                                         | Private Maintenance-Evidence speichert auch die Phase `input`; öffentliche Diagnose bleibt side-sicher                                                               |
| `SP-070` | `runner-run-window-plan-coverage`         | Behoben/verifiziert | Runner | Zyklus 014; unabhängig bestätigt in Zyklus 029, `match_b117c52f54737aa2`, D49 und D68–D74                                                        | Fubar wechselte trotz kostenloser legaler Fähigkeit nicht auf den aktuellen ICE-Typ und lief wiederholt ungebrochen in eine vorhandene Antwort                                                                                                                       | `runner.convert_run_window` bewertet die exakte Modusaktion samt Engine-zertifiziertem Folgepfad                                                                      |
| `SP-071` | `structured-choice-origin-binding`        | Behoben/verifiziert | Runner | Zyklus 014, Seed 3, final `match_f72e37db39652eeb`                                                                                                | Eine legitime Vacuum-Link-Fortsetzung verlor nach mehr als vier Zustandsübergängen durch eine künstliche Hop-Grenze ihre Planherkunft                                                                                                                                | Lückenlose StateVersion-Kette ersetzt die feste Schrittschranke; Resolver vervollständigt nur die gebundene Choice                                                     |
| `SP-072` | `runner-visible-card-mode`                | Behoben/verifiziert | Runner | Zyklus 014, Seed 2, final `match_00aa4f0e62037b40`                                                                                                | Der aktuelle Modus eines sichtbaren flexiblen Breakers fehlte im KI-Input und ließ bezahlbare Zugriffe unbestimmt erscheinen                                                                                                                                          | Actor-sichtbare Karten behalten ihren aktuellen Modus; verdeckte Auswahlfelder bleiben redigiert                                                                      |
| `SP-073` | `structured-choice-origin-binding`        | Behoben/verifiziert | Corp   | Zyklus 030, vor Fix `match_3b2c2cff025ac579`, D234; final `match_3f452dfedbe34ded`, D234                                                        | Eine bereits gewählte Security-Purge-Fortsetzung verlor bei mehreren variablen Rezoptionen die konkrete Variante                                                                                                                                                     | Choice-Wert bewahrt Karte, Server und `rezVariantId` beim bestehenden Defense-Owner                                                                                   |
| `SP-074` | `structured-choice-origin-binding`        | Behoben/verifiziert | Runner | Zyklus 030, vor Fix `match_7dd4daf50f2c89c9`, D241; final `match_3f452dfedbe34ded`, D236–D237                                                  | Eine Programm-Install-Choice bewertete das notwendige Opfer im Choice-Fenster erneut und verlor dadurch die planseitig gewählte Kartenbindung                                                                                                                         | Planursprung bindet die Opferinstanzen; Choice-Resolver ordnet nur noch exakte Options-IDs zu                                                                          |
| `SP-075` | `runner-central-pressure-conversion`      | Behoben/verifiziert | Runner | Zyklus 014, Seed 3, final `match_f72e37db39652eeb`, D213                                                                                         | Eine kostenlose vollständige Viral-Pipeline-Konversion blieb 144-mal hinter niedrigeren Prioritäten liegen, obwohl sie den Corp-Zug direkt verkürzte                                                                                                                  | CardSpec projiziert die Wirkung; `runner.pressure_central` führt das aktuelle P3-Konvertierungsfenster aus                                                             |
| `SP-076` | `corp-punish-route-quote-completeness`    | Verdacht            | Corp   | Zyklus 014, finale Matches `match_84ffbfd10d17e350`, `match_00aa4f0e62037b40`, `match_f72e37db39652eeb`                                    | Nach einem 3-Punkte-Steal ist die Score-Siegroute des Low-Agenda-Decks mathematisch verloren, doch die Corp baut in drei Spielen keinen ausführbaren Tag-/Schadenspfad auf                                                                                             | Frühere Punish-Liquiditätsreserve und Phasenwechsel; ein konkret dominanter früherer Pfad fehlt noch                                                                  |
| `SP-077` | `engine-terminal-access-continuation`     | Behoben/verifiziert | Beide  | Zyklus 015, terminaler Agenda-Zugriff und Engine-Regressionsfall                                                                                   | Nach einem bereits tödlichen Zugriffseffekt wurden verzögerte Access-Belohnungen weiter abgearbeitet und der terminale Zustand verändert                                                                                                                             | Engine beendet den Access-Lifecycle unmittelbar nach einem terminalen Effekt                                                                                           |
| `SP-078` | `runner-known-remote-risk-memory`         | Behoben/verifiziert | Runner | Zyklus 015, Checkpoint `cp-selfplay-015-01-known-access-contract-d151`                                                                             | Bekannte Steal-Kosten und beobachteter Zugriffsschaden gingen bei der erneuten Remote-Bewertung verloren                                                                                                                      | Engine-/Eventfakten bleiben an der bekannten Serverposition gebunden                                                                                                  |
...
Zyklus 035 ergänzt zwei weitere Nullscore-Verläufe mit hoher Defense- und
Economy-Aktivität. Zugleich hält `match_015b492db5c083d2` den Gegenbeweis:
D93–D95 installiert und avanciert **Please Don't Choke Anyone**, Gatekeeper
stoppt den Runner-Contest in D99–D101 und derselbe Scoreowner setzt die Linie
in D104–D106 bis zum Score fort. Eine zweite Agenda bleibt anschließend in
...
Im ersten Seed von Zyklus 035 wählte `runner.rig_and_coverage` in D90
**Temple Microcode Outlet**. Die Engine öffnete das freiwillige
Kosten-/Strafzahlungsfenster, D91 nutzte **Swiss Bank Account**, und D92
veröffentlichte ausschließlich die exakt ursprüngliche Event-Action als
Fortsetzung. Die Enginebindung war vollständig, doch der positive KI-DTO
entfernte die Support- und Fensterfelder. Ohne erkennbare Continuation endete
die Auswahl fail-closed.

Der Fix nimmt ausschließlich die side-sicheren Bindungsfelder in die
actor-private DTO-Allowlist auf, bewahrt Root, Executor, Step und
Original-Action während der Supportunterbrechung und setzt nur die einzige
exakt passende LegalAction fort. Der Support bleibt beim Economy-Owner; die
Fortsetzung kehrt zu `runner.rig_and_coverage` zurück. Abweichende Action-
oder Fenster-IDs scheitern mit `window_origin_missing`.

Status: behoben/verifiziert. Vier Vorläufe reproduzieren denselben Abbruch an
D92. Der finale identische Seed läuft als `match_5c5c7cefbf655e26` mit
D90–D92 und anschließend vollständig bis D329. DTO- und Ownership-Tests
sichern die positive Projektion sowie den Fail-closed-Mismatch.
