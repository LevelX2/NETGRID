...
| `docs/KI-Player/` | 1 | Markdown | KI-Releaseplanung | KI-Briefing | `archive` oder `needs-decision` | Gegen aktuelle AI-Artefakte in `docs/architecture/ai/`, `docs/reviews/ai/` und `docs/releases/ai/` abgleichen. |
...
| `docs/releases/roadmaps/` | 5 | Markdown | Roadmaps, Bestandsaufnahme und Produktvision | releaseübergreifende Planung | `keep-active`, teilweise `keep-evidence` | Roadmap- und Produktvisionsartefakte sind seit 2026-05-18 aus `docs/derived/` migriert; kanonischer Einstieg ist `docs/releases/roadmaps/README.md`. |
