...
| Weitere Root-Altdateien: `docs/CODEX_RUNBOOK_NETGRID_MVP_0_1_0_2.md`, `docs/archive/mvp-0-1-0-2-detailed-test-concept.md` | 2 | Markdown | frühe Codex-/Testkonzeptphase | historischer Steuerungs-/Testbestand | `archive` | Root-Runbook wurde entfernt; das Testkonzept liegt seit 2026-05-18 im Archiv. Bei späterem Archivschnitt gegen moderne Testmatrizen abgleichen. |
| `docs/archive/mvp-0-1-0-2-document-package/` | 15 | Markdown | frühe MVP-0.1/0.2-Spezifikation, Tests, Betrieb, Planung | historisches Dokumentenpaket | `archive` | Seit 2026-05-18 archiviert; keine fachliche Führungsrolle gegenüber aktueller Wissensbasis und heutiger Zielstruktur. |
...
| ehemalig `docs/KI-Player/` | 1 | Markdown | KI-Releaseplanung | KI-Briefing | `keep-evidence` | Am 2026-05-18 als Roadmap-Quellartefakt nach `docs/releases/roadmaps/ai-releaseplanning-codex-briefing-2026-05-07.md` migriert; der Root-Ordner ist aufgelöst. |
...
| `docs/releases/proteus/` mit ehemaligen `docs/derived/PROTEUS_*` | 9 | Markdown | Proteus-Import und Mechanikplanung | Importberichte, Verträge, Coverage-Analysen | `keep-active` oder `keep-evidence` | Proteus-Planungsartefakte sind seit 2026-05-18 nach `docs/releases/proteus/` migriert; kanonischer Einstieg ist `docs/releases/proteus/README.md`. |
| `docs/architecture/ai/`, `docs/reviews/ai/`, `docs/releases/ai/` mit ehemaligen `docs/derived/AI_*`, `DECK_LEGAL_AI_*`, `KING_OF_THE_ROAD_AI_*` und `RUNNER_AI_*` | 32 | Markdown | AI-Hints, Doctrine, Benchmarks, Deck-Legal-Approval, Runner-KI-Beobachtungen | Architekturvorgaben, Release-Evidence und Reviewberichte | `keep-evidence`, aktuelle Diagnosepfade `keep-active` | AI-Artefakte sind seit 2026-05-18 nach Architektur-, Review- und Release-Zielbereichen migriert; keine Hidden-Info- oder Live-KI-Vertragsänderung aus diesem Move. |
| `docs/decisions/` | 2 | Markdown | Docs-Struktur und lokale Kartenattributentscheidungen | dauerhafte Entscheidungen | `keep-active` | Entscheidungen sind seit 2026-05-18 aus `docs/derived/` migriert; kanonischer Einstieg ist `docs/decisions/README.md`. |
| `docs/releases/roadmaps/` | 6 | Markdown | Roadmaps, Bestandsaufnahme, Produktvision und KI-Releaseplanung | releaseübergreifende Planung | `keep-active`, teilweise `keep-evidence` | Roadmap- und Produktvisionsartefakte sind seit 2026-05-18 aus `docs/derived/` migriert; das ehemalige `docs/KI-Player/`-Briefing liegt seit 2026-05-18 als Quellartefakt daneben. Kanonischer Einstieg ist `docs/releases/roadmaps/README.md`. |
| `docs/architecture/card-images/`, `docs/architecture/card-rules/`, `docs/architecture/deck-library/`, `docs/architecture/live-match/` | 13 | Markdown | Kartenbild, Regeln, Deckbibliothek, Timer und Live-Match-Systeme | Architektur- und Vertragsartefakte | `keep-active` oder `keep-evidence` | Die restlichen Architekturartefakte sind seit 2026-05-18 aus `docs/derived/` migriert. |
| `docs/reviews/docs-cleanup/`, `docs/reviews/onr-v1/` | 6 | Markdown | Docs-Struktur, Quellen, Spoiler und Supportdaten | Reviews, Audits und Linkpläne | `keep-evidence` | Die restlichen Querschnittsreviews sind seit 2026-05-18 aus `docs/derived/` migriert. |
...
| `docs/releases/backend-ops/backend-0-5/` mit ehemaligen `docs/derived/BACKEND_0_5_*` | mehrere Dateien | Markdown | private Storage-Maintenance | Backend-/Ops-Zwischenrelease | `keep-evidence`, teilweise `condense` | Backend 0.5 ist seit 2026-05-18 nach `docs/releases/backend-ops/backend-0-5/` migriert. |
