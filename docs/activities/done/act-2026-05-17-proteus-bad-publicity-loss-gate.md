...
checks:
  ...
  - rg -n "Proteus planning|no runtime implementation|Keine Proteus-Kartenpromotion|human_playable|ai_supported|deck_legal" docs/derived/PROTEUS_BAD_PUBLICITY_LOSS_GATE_CONTRACT.md docs/activities/inbox/act-2026-05-17-proteus-bad-publicity-engine-harness.md
  - git diff --check
---
