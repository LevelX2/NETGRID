...
- Zwei obsolete produktive Module wurden samt toter Export-/Metrikoberfläche entfernt; sieben neue fokussierte Testdateien schließen direkte Regressionstestlücken. Insgesamt betrifft der integrierte Reviewstand 77 Dateien mit 1.621 Ergänzungen und 983 Entfernungen gegenüber dem vorherigen `main`.
