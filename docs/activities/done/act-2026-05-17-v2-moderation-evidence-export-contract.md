...
blockedBy: []
resultArtifacts:
  - docs/releases/v2/v2-6-moderation/evidence-export-contract.md
checks:
  - "rg -n \"Evidence-Export|FullState|privatePayload|AIInput|DecisionDebug|local_analysis|Public Replay|Account-Datenexport\" docs/releases/v2/v2-6-moderation/evidence-export-contract.md docs/activities/done/act-2026-05-17-v2-moderation-evidence-export-contract.md"
