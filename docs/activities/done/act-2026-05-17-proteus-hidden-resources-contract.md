...
checks:
  - rg -n "hidden_runner_resources|onr_proteus_128|onr_proteus_154" data/rules/proteus-mechanics-coverage-2026-05-17.json docs/derived/PROTEUS_HIDDEN_RUNNER_RESOURCES_CONTRACT_2026_05_17.md
  - rg -n "hidden_resource_foundation_no_card_promotion|Keine Proteus-Kartenfreigabe|keine Runtime-Resolver" docs/derived/PROTEUS_HIDDEN_RUNNER_RESOURCES_CONTRACT_2026_05_17.md docs/activities/inbox/act-2026-05-17-proteus-hidden-resource-foundation-slice.md
  - git diff --check
---
