...
- Der aktuelle lokale `main` (`6f2885120`) wurde konfliktfrei in den Arbeitsbranch integriert. Danach bestanden die fokussierten Regressionen für alle geänderten Risikopfade und Strukturgrenzen: 11 Testdateien, 151 Tests grün. Der zusätzliche Vergleichslauf der bekannten roten Checkpoints bestätigte 15 bestehende Fehlschläge bei 77 grünen Tests; `match-3aac` und der aktualisierte Deck-Vollständigkeitstest sind grün.
