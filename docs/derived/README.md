...
Erste Pilot-Moves seit 2026-05-18 sind die abgeschlossene Backend-0.5-Familie unter `docs/releases/backend-ops/backend-0-5/`, die AI-Architecture-/Review-/Release-Artefakte unter `docs/architecture/ai/`, `docs/reviews/ai/` und `docs/releases/ai/`, die historische MVP-0.x-Kette unter `docs/releases/mvp/`, die Proteus-Planungsartefakte unter `docs/releases/proteus/`, die S01-Sonderphase unter `docs/releases/special/s01/`, die V1.0- bis V1.9.22-Familien unter `docs/releases/v1/`, die aktiven V2.x-Plattformverträge unter `docs/releases/v2/`, die Originalset-Spotcheck-Evidence unter `docs/reviews/originalset-spotchecks/`, die abgeschlossenen Originalset-Spotcheck-Jobs unter `docs/archive/originalset-spotcheck-jobs/2026-05/` und die Ability-Engine-Architektur unter `docs/architecture/ability-engine/`.
