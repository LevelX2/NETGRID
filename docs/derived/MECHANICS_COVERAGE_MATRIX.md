# Mechanics Coverage Matrix 0.95

Status: V0.95 Resources und Tag-Interaktion umgesetzt
Stand: 2026-05-04
Maschinenlesbar: `data/rules/mechanics-coverage-0.95.json`

## Zweck

Diese Matrix normalisiert den aktuellen Mechanikstand nach V0.95. Sie ersetzt keine Regelreferenz, sondern ist das Gate-Artefakt, das spätere Mechanikarbeit vor verdeckten Alt-Deviations schützt.
...
| `mechanic.tags.basic` | Tags, Remove Tag, einfache Tag-Punishment, Resource-Trash | `implemented_limited` | P1 | mittel | erledigt/V0.95 | Grundtags existieren; V0.95 ergänzt die Corp-Basisaktion gegen installierte Resources. Trace fehlt. |
...
| DEV-007 Tags/Trace/Damage/Viren | partial | Tags, V0.94 Damage und V0.95 Resources sind teilweise umgesetzt; Trace und Viren bleiben offen. |
