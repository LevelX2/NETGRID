...
Update 2026-05-14 19:50 CEST: `Zetatech Software Installer` hat einen engen Overlay-Runtime-WIP nach `docs/derived/V1_9_22_ZETATECH_OVERLAY_RUNTIME_CONTRACT.md`. Der neue Smoke deckt Overlay-Install-LegalAction, Wrong-Side/Stale, Recurring-Credit-Zahlung, MU/`hostedOn`, PublicPayload und Replay/StateHash ab; `typecheck`, `engine` 309, `catalog` 44, `ai` 86, `server` 72, `web` 79, `test`, `lint` und `build` gruen.
