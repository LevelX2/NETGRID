...
| Resolver | Jede Karte hat Adapter oder Blocker | Runtime-Definitionen fuer 9 Runner-Hardware- und 10 Runner-Event-Zielkarten; Events noch ohne LegalAction-Smoke |
...
| Full Checks | catalog, engine, ai, server, web, typecheck, test, lint, build | Gruen fuer Runtime-WIP: JSON 302, engine 274, catalog 36, typecheck |
