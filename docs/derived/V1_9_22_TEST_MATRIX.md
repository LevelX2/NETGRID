...
| Resolver | Jede Karte hat Adapter oder Blocker | Runtime-Definitionen fuer 9 Runner-Hardware-, 10 Runner-Event- und 6 Corp-Longtail-Zielkarten; `If You Want It Done Right...` hat einen privaten Stack-Top-5-Resolver, `Organ Donor` einen privaten Grip-Trash-Resolver, die uebrigen Events behalten No-`play_event`-Promotion-Guards |
...
| LegalAction/applyAction | Side, Timing, Quelle, Ziel, Kosten und Choices revalidiert | 9/9 Runner-Hardware-Install-LegalActions sowie `If You Want It Done Right...`, `Organ Donor`, `Corporate Retreat`, `Corporate War`, `Marine Arcology`, `Political Overthrow`, `Off-Site Backups` und `Planning Consultants` inkl. Wrong-Side-/Stale-Revalidation gruen |
| Visibility | Keine Hidden-Info-Leaks ueber PlayerViews/PublicEvents/Reconnect/Undo | 9/9 Runner-Hardware-Install-PublicPayloads/PlayerViews sowie If-You-Want-It-Done-Right-/Organ-Donor-/Corporate-Retreat-/Corporate-War-/Marine-Arcology-/Political-Overthrow-/Off-Site-Backups-/Planning-Consultants-PublicPayloads gruen |
| Replay/StateHash | Neue Effekte sind deterministisch replaybar | 9/9 Runner-Hardware-Install-Replay/StateHash sowie If-You-Want-It-Done-Right-/Organ-Donor-/Corporate-Retreat-/Corporate-War-/Marine-Arcology-/Political-Overthrow-/Off-Site-Backups-/Planning-Consultants-Replay/StateHash gruen |
