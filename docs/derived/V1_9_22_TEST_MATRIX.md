...
| Resolver | Jede Karte hat Adapter oder Blocker | Runtime-Definitionen fuer 9 Runner-Hardware-, 10 Runner-Event- und 6 Corp-Longtail-Zielkarten; `If You Want It Done Right...` hat einen privaten Stack-Top-5-Resolver, `misc.for-sale` einen privaten Installed-Trash-Resolver, `Organ Donor` einen privaten Grip-Trash-Resolver, die uebrigen Events behalten No-`play_event`-Promotion-Guards |
...
| LegalAction/applyAction | Side, Timing, Quelle, Ziel, Kosten und Choices revalidiert | 9/9 Runner-Hardware-Install-LegalActions sowie `If You Want It Done Right...`, `misc.for-sale`, `Organ Donor`, `Corporate Retreat`, `Corporate War`, `Marine Arcology`, `Political Overthrow`, `Off-Site Backups` und `Planning Consultants` inkl. Wrong-Side-/Stale-Revalidation gruen |
| Visibility | Keine Hidden-Info-Leaks ueber PlayerViews/PublicEvents/Reconnect/Undo | 9/9 Runner-Hardware-Install-PublicPayloads/PlayerViews sowie If-You-Want-It-Done-Right-/misc-for-sale-/Organ-Donor-/Corporate-Retreat-/Corporate-War-/Marine-Arcology-/Political-Overthrow-/Off-Site-Backups-/Planning-Consultants-PublicPayloads gruen |
| Replay/StateHash | Neue Effekte sind deterministisch replaybar | 9/9 Runner-Hardware-Install-Replay/StateHash sowie If-You-Want-It-Done-Right-/misc-for-sale-/Organ-Donor-/Corporate-Retreat-/Corporate-War-/Marine-Arcology-/Political-Overthrow-/Off-Site-Backups-/Planning-Consultants-Replay/StateHash gruen |
...
| Full Checks | catalog, engine, ai, server, web, typecheck, test, lint, build | Gruen nach Runtime-Resolver-WIP: engine 287, catalog 44, ai 86, server 72, web 79, typecheck, test, lint und build; Build nur mit bekannter nicht-blockierender Turbopack-NFT-Warnung |
