...
Für den späteren Requirements-Freeze braucht V0.9 stabile IDs mit Akzeptanzkriterien. Diese Tabelle ist die Planungsfassung und soll im Freeze in `docs/derived/MVP_0.9_REQUIREMENTS.md` überführt werden.
