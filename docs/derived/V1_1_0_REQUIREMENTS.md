...
V1.1.0 setzt den M2-Setup-/Game-End-Vertrag aus `docs/derived/SETUP_GAME_END_0.93_SPEC.md` produktiv um und integriert die NETGRID-Statusklarheit aus `docs/derived/V1_1_0_SETUP_GAME_END_M2_DETAILED_PLAN.md`.
