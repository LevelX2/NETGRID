...
Auswahlart: zufällige 10er-Stichprobe aus komplexeren bereits decklegalen Originalset-Karten. Karten aus `docs/derived/ORIGINALSET_CARD_SPOTCHECK_REGISTER.md` Runde 2026-05-14-A wurden ausgeschlossen.
