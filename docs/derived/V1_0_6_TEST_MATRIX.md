...
- `corepack pnpm build`
- `git diff --check`
- V1.0.6 Browser-/Playtest-Smoke aus `docs/derived/V1_0_6_BROWSER_PLAYTEST_SMOKE.md`
...
Alle Must-Anforderungen aus `docs/derived/V1_0_6_REQUIREMENTS.md` haben mindestens eine Testspur in dieser Matrix.
