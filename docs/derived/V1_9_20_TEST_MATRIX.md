...
| Action Economy | Click-/Action-Modifikatoren nur aus sichtbaren legalen Quellen | Remote-Facility/Nevinyrral/Pacifica-Assetpfad inkl. Wrong-Side-/Stale-State-Rejection grün; weitere Action-Familien Folgearbeit |
...
| Full Checks | catalog, engine, ai, server, web, typecheck, test, lint, build | JSON-Validation 285, Catalog 34, Engine 265, AI 85, Server 72, Web 76, Typecheck, Test, Lint und Build grün; Build nur mit bekannter NFT-Warnung |
