...
| Full Checks | catalog, engine, ai, server, web, typecheck, test, lint, build | JSON-Validation, Catalog 34, Engine 264 und Typecheck grün; weitere Checks Folgearbeit |
