...
| V112A-T004 | Hidden-Klassifikation | V112A-MUST-006 | Engine-Test: facedown Archives-Queue-Einträge sind `hiddenInfo: true` oder gleichwertig klassifiziert. |
| V112A-T005 | Reveal beim Access | V112A-MUST-007, V112A-MUST-008 | Engine-Test: `access_card` revealt nur aktuellen facedown Archives-Eintrag. |
| V112A-T006 | Keine künftigen Leaks | V112A-MUST-008, V112A-MUST-009, V112A-MUST-010 | Engine/Visibility-Test: PublicEvents und accessedSummaries enthalten keine künftigen facedown Titel. |
...
| V112A-T008 | Trash aus Archives | V112A-MUST-012 | Engine-Test: trashbare Karte aus Archives wird nicht doppelt in Archives angehängt. |
| V112A-T009 | Decline/Weiter | V112A-MUST-013 | Engine-Test: Decline schließt aktuellen Eintrag und bewegt Breach zum nächsten Eintrag oder Ende. |
| V112A-T010 | Undo-Barriere | V112A-MUST-014, V112A-MUST-015 | Server/Engine-Test: facedown Archives-Access blockiert Undo; faceup-only Access-Verhalten ist dokumentiert. |
...
| --- | --- | --- |
| V112-E2E-001 | Archives-Breach Desktop | Runner greift gemischte Archives an; facedown Karte wird erst beim Access sichtbar. |
| V112-E2E-002 | Archives-Breach Reconnect | Reconnect während Access zeigt Fortschritt ohne künftige hidden Titel. |
| V112-E2E-003 | Archives Leak Scan | DOM/Storage/Payload enthalten keine facedown Archives-Titel vor Access. |
