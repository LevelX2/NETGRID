...
- Konkrete LegalAction-/applyAction-Abdeckung für Upgrade-/Root-/Grid-/Access-/Ambush-/Trace-/Tag-/Damage-/Counter-Pfade.
...
- `scripts/automation/v1-9-install-and-check.ps1 -Task engine`: pass, 245 Tests.
