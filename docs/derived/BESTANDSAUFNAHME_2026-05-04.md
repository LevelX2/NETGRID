...
- `KI-Wissen-Netrunner/02 Wissen/00 Uebersichten/Roadmap nach MVP 0.4.md` nannte V0.5 bis V0.9 als abgeschlossen, aber V0.94 bis V0.99/S01 und O:NR nicht als aktuellen Anschluss.
- `docs/derived/MECHANICS_COMPLETION_PLAN.md` war eine historische Planungsfassung und nannte als nächsten Schritt noch V0.94 Requirements, obwohl V0.94 bis V0.99 abgeschlossen sind.
...
- `vitest.config.ts` wurde erweitert, damit `apps/web/app/chronicle.test.ts` im normalen `@netrunner/web`-Testlauf entdeckt wird.
