...
- `docs/derived/ORIGINALSET_CARD_SPOTCHECK_2026_05_15_TURBEAU_TUTOR_IMPLEMENTATION.md`
...
- Vorhandene Jobberichte: `docs/derived/originalset-spotcheck-jobs/done/spotcheck-2026-05-15-netwatch-spinn.md` und `docs/derived/originalset-spotcheck-jobs/done/spotcheck-2026-05-15-ramming-galveston.md`.
