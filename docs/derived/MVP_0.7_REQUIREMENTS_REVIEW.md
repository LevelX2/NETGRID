...
Der V0.7 Requirements/Design Freeze ist abgeschlossen. Die Anforderungen sind aus `docs/derived/MVP_0.7_DETAILED_PLAN.md`, `docs/ui-designsets/README.md` und `docs/ui-designsets/REALISM_REVIEW.md` abgeleitet und auf den aktuellen V0.6-Stand begrenzt.
