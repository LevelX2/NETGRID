...
Die V1.9.18-Kartentexte sind finale display-only Texte aus lokal bestätigten Regelkern-Aussagen nach `docs/derived/V1_9_ORIGINALSET_DISPLAY_TEXT_FINALIZATION_POLICY.md`. Kartentext bleibt keine Parser-, Engine-, LegalAction-, KI-, Replay- oder StateHash-Autorität.
