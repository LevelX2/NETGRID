...
Die Umsetzung darf erst starten, wenn die folgenden Entscheidungen als verbindlich übernommen sind. Das ausführliche Requirements-Dokument liegt in `docs/derived/V1_0_4_REQUIREMENTS.md`.
