...
- Ein Engine-Guard bestaetigt fuer die verbleibenden 11/14 Corp-Agenda-/ICE-/Operations-Zielkarten, dass sie bis zu konkreten Resolvern nicht `playable_mvp` sind. `Corporate War`, `Political Overthrow` und `Planning Consultants` sind die drei bewusst eng umgesetzten Ausnahmen dieses WIP-Schnitts.
