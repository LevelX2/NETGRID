...
- Ein Engine-Guard bestaetigt fuer die verbleibenden 9/14 Corp-Agenda-/ICE-/Operations-Zielkarten, dass sie bis zu konkreten Resolvern nicht `playable_mvp` sind. `Corporate Retreat`, `Corporate War`, `Political Overthrow`, `Off-Site Backups` und `Planning Consultants` sind die fuenf bewusst eng umgesetzten Ausnahmen dieses WIP-Schnitts.
