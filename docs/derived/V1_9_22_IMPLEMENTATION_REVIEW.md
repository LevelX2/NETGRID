...
- `Data Fort Reclamation` hat eine Runtime-Definition und einen engen On-score-Install-Sequence-WIP: Korp-private HQ-Choice bis 4 installierbare Karten, neues Remote, verdeckte ICE-/Root-Installation, side-sichere Count-Payloads und Replay/StateHash. Optionales Rezzen und echte temporaere Credit-Ausgaben bleiben deferred.
