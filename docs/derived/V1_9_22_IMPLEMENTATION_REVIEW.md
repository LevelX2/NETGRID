...
- Ein Engine-Guard bestaetigt fuer die verbleibenden 10/14 Corp-Agenda-/ICE-/Operations-Zielkarten, dass sie bis zu konkreten Resolvern nicht `playable_mvp` sind. `Corporate War`, `Political Overthrow`, `Off-Site Backups` und `Planning Consultants` sind die vier bewusst eng umgesetzten Ausnahmen dieses WIP-Schnitts.
