...
- Zehn Runner-Event-Zielkarten haben Runtime-Definitionen mit finalen display-only Texten, ohne `play_event`-LegalAction-Promotion: Anonymous Tip, Core Command: Jettison Ice, Forged Activation Orders, If You Want It Done Right..., misc.for-sale, Open-Ended Mileage Program, Organ Donor, Security Code WORM Chip, Synchronized Attack on HQ und Valu-Pak Software Bundle.
...
- `scripts/automation/v1-9-install-and-check.ps1 -Task engine`: pass, 274 Tests.
