...
- Ein Engine-Guard bestaetigt fuer die verbleibenden 4/14 Corp-Agenda-/ICE-/Operations-Zielkarten, dass sie bis zu konkreten Resolvern nicht `playable_mvp` sind. `Corporate Retreat`, `Corporate War`, `Marine Arcology`, `Political Overthrow`, `Zombie`, `Tutor`, `Virizz`, `Edgerunner, Inc., Temps`, `Off-Site Backups` und `Planning Consultants` sind die zehn bewusst eng umgesetzten Ausnahmen dieses WIP-Schnitts.
