...
V1.9.12 ist erst abgeschlossen, wenn alle Musts nachweisbar erfuellt sind, die volle Checkgruppe gruen ist und `docs/derived/V1_9_12_FINAL_REVIEW.md` das Gate bestaetigt.
