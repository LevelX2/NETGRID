...
## Offene Entscheidungen vor Requirements-Freeze

Diese Punkte blockieren nicht die Detailplanung, aber sie müssen im jeweiligen Freeze geklärt werden:
...
Die Versionsnummern sind weniger wichtig als die Gate-Reihenfolge. Wenn ein Gate verschoben wird, muss der folgende Plan explizit dokumentieren, welche Abhängigkeit dadurch entfällt oder als Risiko akzeptiert wird.
