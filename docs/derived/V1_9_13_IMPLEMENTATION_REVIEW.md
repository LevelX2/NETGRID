...
- Die Zielkarten haben finale display-only Texte in `packages/shared/src/index.ts`; diese Texte sind nach `docs/derived/V1_9_ORIGINALSET_DISPLAY_TEXT_FINALIZATION_POLICY.md` aus lokal bestaetigten Regelkern-Aussagen abgeleitet.
