...
| `docs/releases/v1/` mit ehemaligen `docs/derived/V1_0_*` bis `V1_8_*` | mehrere Dutzend | Markdown | Stabilisierung, UX, Storage, Hardening, Setup, Archives, Mechanics-AI-Baseline, Event/Replacement, Special Zones, Format, Card Data Pipeline, KI, Belief, Simulation, Replay, Tutorial, Mechanikpakete | Releasepläne, Requirements, Specs, Reviews, Smokes | `keep-evidence`, teilweise `condense` | V1.0- bis V1.8.1-Familien sind seit 2026-05-18 nach `docs/releases/v1/` migriert; kanonischer Einstieg ist `docs/releases/v1/README.md`. |
...
3. `docs/derived/` zuerst entlang bestehender Releaseketten verdichten: MVP-0.x, V1.9-Originalset, V2-Plattform, Proteus, AI.
