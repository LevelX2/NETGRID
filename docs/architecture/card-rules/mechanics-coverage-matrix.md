...
| `mechanic.trace.link_bidding` | Trace, Link, Bidding | `implemented_limited` | P1 | sehr hoch | erledigt/V0.96 | Trace ist als öffentliche Corp-/Runner-Bid-Sequenz spielbar. `Trace N` ist das Korp-Gebotslimit; der bezahlte Trace-Wert gewinnt bei `traceValue >= runnerStrength`. V0.98 nutzt den Runner-Link der aktiven Identity. |
