...
| Score-/Defense-Mehrschrittlinien                                                                    | [corp-agenda-turn-planning.ts](../../../packages/ai/src/corp/score/corp-agenda-turn-planning.ts), [corp-defense-turn-planning.ts](../../../packages/ai/src/corp/defense/corp-defense-turn-planning.ts)                           |
...
| `CorpHandPlanningRecord`                                                      | `CorpHandInventoryFacts` und `CorpHandRouteCoverageRecord` in [hand-inventory-facts.ts](../../../packages/ai/src/corp/hand-management/hand-inventory-facts.ts)                     |
