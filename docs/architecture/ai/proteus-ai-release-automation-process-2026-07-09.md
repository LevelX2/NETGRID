...
| PAI-4  | `done` | Vier Deckpaarungen über vier feste Seeds liefern 16 Pilotspiele: 0 IllegalActions, 0 Replay-/Redaction-Fehler, 31,3 % Abschluss-, 68,8 % Action-Limit-, 12,5 % No-Progress- und 0 % Fallback-Rate; vier Originalset-Kontrollen sind grün. Vier dabei gefundene Engine-Lücken wurden reproduziert, regressionsgetestet und geschlossen. |
