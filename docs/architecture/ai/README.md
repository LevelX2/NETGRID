...
| `runner.develop_board_and_hand`   | [developmentModule](../../../packages/ai/src/plans/runner-tactical-plan-modules.ts#L843)                                    | [Runner §5](runner-plan-contracts.md#5-runnerdevelop_board_and_hand)                                 |
