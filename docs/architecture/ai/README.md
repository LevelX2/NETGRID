...
| `runner.economy`                  | [economyModule](../../../packages/ai/src/plans/runner-core-plan-modules.ts#L670)                                            | [Runner §6](runner-plan-contracts.md#6-runnereconomy)                                                |
| `runner.rig_and_coverage`         | [coverageModule](../../../packages/ai/src/plans/runner-core-plan-modules.ts#L871)                                           | [Runner §4](runner-plan-contracts.md#4-runnerrig_and_coverage)                                       |
| `runner.defense_and_recovery`     | [defenseModule](../../../packages/ai/src/plans/runner-core-plan-modules.ts#L1068)                                           | [Runner §7](runner-plan-contracts.md#7-runnerdefense_and_recovery)                                   |
...
| `corp.punish_campaign`            | [punishCampaignModule](../../../packages/ai/src/plans/corp-tactical-plan-modules.ts#L355)                                   | [Corp §7](corp-plan-contracts.md#7-corppunish_campaign)                                              |
| `corp.execute_punish_sequence`    | [punishSequenceModule](../../../packages/ai/src/plans/corp-tactical-plan-modules.ts#L432)                                   | [Corp §8](corp-plan-contracts.md#8-corpexecute_punish_sequence)                                      |
| `corp.ambush_and_bluff`           | [ambushModule](../../../packages/ai/src/plans/corp-tactical-plan-modules.ts#L546)                                           | [Corp §9](corp-plan-contracts.md#9-corpambush_and_bluff)                                             |
| `corp.hand_and_agenda_management` | [handModule](../../../packages/ai/src/plans/corp-tactical-plan-modules.ts#L794)                                             | [Corp §10](corp-plan-contracts.md#10-corphand_and_agenda_management)                                 |
