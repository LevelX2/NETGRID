...
- `semantic-ai-production-readiness-automation-process-2026-06-04.md`: Semantic AI Production Readiness META 7 bis META 12 für Multi-Run Evaluation, Human-Review-Closure, Internal Canary, Production-Safe Shadow, limited scoped Cutover, Scope Expansion, Kalibrierung und Legacy-Freeze-Stabilisierung. Full Production, Bulk-Aktivierung und Legacy Removal bleiben ausgeschlossen.
