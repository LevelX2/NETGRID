...
1. `NETGRID_MVP_0.1_Konsolidiertes_Konzept_geprueft.md` ist die verbindliche Arbeitsfassung für MVP 0.1. Sie ersetzt ältere Konzeptzwischenstände.
2. `NETGRID_MVP_0.2_Plan.md` ist die verbindliche Planungsgrundlage für MVP 0.2. MVP 0.2 darf erst nach einem bestandenen MVP-0.1-Gate begonnen werden.
...
4. `Null_Signal_Games_NETGRID_Comprehensive_Rules_v26.03.pdf` ist Regelreferenz, aber nicht Scope-Erweiterung. Jede MVP-Abweichung wird dokumentiert.
...
MVP 0.2 ist keine Erweiterung des Kartenpools und kein Ausbau komplexer NETGRID-Regeln. MVP 0.2 ist die private Multiplayer-Schicht über der stabilen 0.1-Engine: zwei Menschen spielen über privaten Link, serverautoritative WebSocket-Synchronisation, getrennte PlayerViews, Reconnect, kontrolliertes Undo, Persistenz, Concurrency-Schutz und Multiplayer-Visibility-Tests.
...
/netgrid-app
  ...
  /docs
    /source
      ...
      Null_Signal_Games_NETGRID_Comprehensive_Rules_v26.03.pdf
    /codex
      CODEX_RUNBOOK_NETGRID_MVP_0_1_0_2.md
      CODEX_STATUS.md
      GOAL_HISTORY.md
    /derived
...
## Project
Private NETGRID web application. MVP 0.1 is Human Runner vs simple Corp AI with fixed demo decks. MVP 0.2 is private Human-vs-Human multiplayer over the same engine.

## Source priority
1. `/docs/source/NETGRID_MVP_0.1_Konsolidiertes_Konzept_geprueft.md` for MVP 0.1.
2. `/docs/source/NETGRID_MVP_0.2_Plan.md` for MVP 0.2 after MVP 0.1 gates pass.
3. `/docs/source/Erstes Testdeck.txt` for demo cards and demo decks.
4. `/docs/source/Null_Signal_Games_NETGRID_Comprehensive_Rules_v26.03.pdf` as rules reference only.
5. `/docs/codex/CODEX_RUNBOOK_NETGRID_MVP_0_1_0_2.md` for Codex workflow.
...
```text
Create or continue a persistent goal named "NETGRID repository setup and Codex guidance".
...
Read AGENTS.md and /docs/codex/CODEX_RUNBOOK_NETGRID_MVP_0_1_0_2.md first.
...
Secondary source:
- /docs/source/NETGRID_MVP_0.2_Plan.md only for future-compatibility awareness. Do not expand MVP 0.1 scope.
...
3. Dieses Runbook nach `/docs/codex/CODEX_RUNBOOK_NETGRID_MVP_0_1_0_2.md` kopieren.
