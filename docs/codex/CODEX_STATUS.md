...
O:NR-v1 aktiver Runtime-Werteaudit vom 2026-05-14 15:52 CEST: Die bereits aktivierten 327 Karten aus dem exportierten `ONR_V1_RUNTIME_RELEASE_CARD_IDS` wurden gegen `docs/source/Runnerspoiler 1.0.txt` und `docs/source/Corpspoiler 1.0.txt` abgeglichen. Ergebnis: 327/327 zugeordnet, 0 verbleibende maschinenlesbare Wertabweichungen nach Korrektur von Engine-Definitionen, Catalog-Zahlenbasis und Test-Erwartungen. Schwerpunktkorrekturen umfassen u. a. `The Shell Traders` Install 0, mehrere Runner-Event-/Resource-Kosten, Agendawerte, ICE-Rez-/Staerkewerte, ICE-Subtypes, Trace-Staerken und spaetere aktive V1.9.16-bis-V1.9.21-Kartenwerte. Neuer Nachweis: `docs/derived/ONR_V1_ACTIVE_RUNTIME_SPOILER_VALUE_AUDIT_2026_05_14.md`. Verifikation: `engine` 301, `catalog` 44 und `typecheck` gruen. Keine Release-, Catalog- oder AI-Promotion.
