...
V1.9.22 Runner-Programm-Preflight vom 2026-05-13 23:59 CEST: `docs/derived/V1_9_22_RUNNER_PROGRAM_IMPLEMENTATION_PREFLIGHT.md` markiert `Newsgroup Filter` und `Shield` als kleinste Programm-Kandidaten, sobald Aktivierungstiming bzw. Prevention-Fenster lokal bestaetigt sind. Die 14 Programmkarten bleiben bis dahin durch No-Playable-/No-LegalAction-Guards geschuetzt.
