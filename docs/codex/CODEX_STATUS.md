...
V1.9.19-WIP-Fortsetzung vom 2026-05-13 14:09 CEST: Der Agenda-Difficulty-/Scored-Agenda-/Overadvance-Slice hat jetzt konkrete Engine-Pfade für Agenda-Core, Operationen und erste Asset-Randpfade, bleibt aber ohne Runtime-/AI-Promotion. Artificial Security Directors und Genetics-Visionary Acquisition berechnen Score-Difficulty, Overadvance und Bonus-Agenda-Counter engine-seitig; Roving Submarine und Washington, D.C., City Grid wirken als rezzed servergebundene Difficulty-Modifier; gescorte Artificial Security Directors/Genetics-Visionary Acquisition öffnen eine side-sichere R&D-Top-Reveal-LegalAction. Project Consultants, Falsified-Transactions Expert, Management Shake-Up, Silver Lining Recovery Protocol, Systematic Layoffs und Team Restructuring haben explizite `play_operation`-Resolver für Advancement, Power-Counter, Economy und öffentliche Forfeit-Kosten. Zusätzlich decken Chicago Branch/Vapor Ops rezzed Power-Counter-LegalActions, Information Laundering eine rezzed Economy-LegalAction und Experimental AI einen legalen Access-Ambush gegen installierte Runner-Programme ab. Führende WIP-Artefakte aktualisiert: `docs/derived/V1_9_19_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_19_TEST_MATRIX.md`, `data/scenarios/v1919-agenda-overadvance-wip-smoke.json`, `data/manifests/card-implementation-manifest-1.9.19.json`, `data/rules/mechanics-coverage-1.9.19.json`. Verifikation nach diesem Schnitt: JSON-Validation 277, `engine` 256, `catalog` 33 und `typecheck` grün; vorheriger Vollcheck im selben Lauf: `ai` 85, `server` 72, `web` 76, `test`, `lint` und `build` grün mit bekannter nicht-blockierender Turbopack-NFT-Warnung. Completion-Gate bleibt offen für weitere Ambush-/Damage-Pfade, finale Daten-/AI-Artefakte, offizielle AI-Approval, Final Review, Release-Promotion und Webclient-Version.
