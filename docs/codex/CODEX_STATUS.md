...
V1.9.19-WIP-Fortsetzung vom 2026-05-13 14:11 CEST: Der Agenda-Difficulty-/Scored-Agenda-/Overadvance-Slice hat jetzt konkrete Engine-Pfade für Agenda-Core, Operationen und Asset-/Ambush-Randpfade, bleibt aber ohne Runtime-/AI-Promotion. Artificial Security Directors und Genetics-Visionary Acquisition berechnen Score-Difficulty, Overadvance und Bonus-Agenda-Counter engine-seitig; Roving Submarine und Washington, D.C., City Grid wirken als rezzed servergebundene Difficulty-Modifier; gescorte Artificial Security Directors/Genetics-Visionary Acquisition öffnen eine side-sichere R&D-Top-Reveal-LegalAction. Project Consultants, Falsified-Transactions Expert, Management Shake-Up, Silver Lining Recovery Protocol, Systematic Layoffs und Team Restructuring haben explizite `play_operation`-Resolver für Advancement, Power-Counter, Economy und öffentliche Forfeit-Kosten. Chicago Branch/Vapor Ops, Information Laundering, Experimental AI, Corprunner's Shattered Remains, Vacant Soulkiller und Virus Test Site decken Counter, Economy, installierte-Karten-Trash, Core Damage und Net Damage über LegalAction-/Access-Fenster ab. Führende WIP-Artefakte aktualisiert: `docs/derived/V1_9_19_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_19_TEST_MATRIX.md`, `data/scenarios/v1919-agenda-overadvance-wip-smoke.json`, `data/manifests/card-implementation-manifest-1.9.19.json`, `data/rules/mechanics-coverage-1.9.19.json`. Verifikation nach diesem Schnitt: `engine` 257 grün; vorheriger Schnitt im selben Lauf: JSON-Validation 277, `catalog` 33 und `typecheck` grün; vorheriger Vollcheck: `ai` 85, `server` 72, `web` 76, `test`, `lint` und `build` grün mit bekannter nicht-blockierender Turbopack-NFT-Warnung. Completion-Gate bleibt offen für Fait Accompli, Arasaka Owns You, Olivia Salazar, finale Daten-/AI-Artefakte, offizielle AI-Approval, Final Review, Release-Promotion und Webclient-Version.
