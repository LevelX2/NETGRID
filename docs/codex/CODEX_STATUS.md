...
Latest V1.2.1 mechanics coverage artifact: `data/rules/mechanics-coverage-1.2.1.json`.
...
Current selected next scope: Anschlussplanung nach V1.2.1 gemäß `docs/derived/NETGRID_CONSOLIDATED_RELEASE_ROADMAP.md`. V1.1.3 Baseline-Preflight, V1.2.0 Event Modification Foundation und V1.2.1 Replacement Effects sind abgeschlossen und lokal verifiziert. V1.1.2K kleines Kartenrelease, V1.1.2 Full Archives Access und Matchstart Entry UX, V1.1.1 Discard/Handlimit/Core Damage, V1.1.0 Setup/Game-End M2, V1.0.9 Private Internet Hardening and V1.0.8 Storage/Backup-Härtung are complete and locally verified. The V1.0.5 formal gate remains historically incomplete because no dedicated V1.0.5 implementation/final review artifacts exist, but the workspace code supplied the required V1.0.5 UI baseline for V1.0.6 and V1.0.7 QA.
