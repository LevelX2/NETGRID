...
V1.9.16-WIP-Lauf vom 2026-05-13 08:20 CEST: Der Program Subtypes, Hosting, Stealth, Worm und Installed-card-Destroy-Slice ist release-spezifisch detailgeplant und im Runtime-WIP begonnen. Der Scope umfasst genau 16 Karten von `Baedeker's Net Map` bis `Fragmentation Storm` aus der V1.9.10-bis-V1.9.xx-Matrix. Neue führende WIP-Artefakte: `docs/derived/V1_9_16_DETAILED_PLAN.md`, `docs/derived/V1_9_16_REQUIREMENTS.md`, `docs/derived/V1_9_16_PROGRAM_SUBTYPE_HOSTING_STEALTH_SPEC.md`, `docs/derived/V1_9_16_TEST_MATRIX.md`, `docs/derived/V1_9_16_REQUIREMENTS_REVIEW.md`, `docs/derived/V1_9_16_IMPLEMENTATION_REVIEW.md`. `packages/shared/src/index.ts` enthält WIP-Runtime-Definitionen fuer alle 16 Zielkarten, und `packages/catalog/src/index.ts` fuehrt `ONR_V1_9_16_WIP_CARD_IDS` als No-Promotion-Guard. Verifikation: `engine` (228), `catalog` (30) und `typecheck` sind grün. Keine Karte wurde promotet; der Cursor bleibt auf V1.9.16 in Phase `implementing`.
