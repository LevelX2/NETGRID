...
Stand: 2026-05-24  
Status: Planungs-Handoff mit abgeschlossenen Detail-Implementierungsslices 1a, 1b, 1d und 1g; keine Decklegalität, keine Formatlegalität, keine AI-Hints.
...
Status 2026-05-24: Phase 8a bis 8f sind umgesetzt. 8d promotet `Highlighter`, `Taxman`, `Vienna 22` und `Viral Pipeline`, 8e promotet `Crumble` und `Garbage In`, 8f promotet `Armageddon` und `Scaldan` als `human_playable`, ohne Decklegalität, Formatlegalität oder AI-Support zu ändern.
