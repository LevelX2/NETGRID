...
`docs/releases/proteus/` bündelt die Artefakte für den importierten Proteus-Kartenstand. Nach PRO020 stehen 154/154 Karten als konkrete CardImplementation-Dateien bereit. Alle 154 Karten sind human-playable, `deck_legal`, `format_legal` und seit Aufgabe 046 technisch `ai_supported`; explizit ausgewählte Proteus-KI-Decks sind zulässig. Diese technische Deckzulassung ist keine Default-/Random-Pool- oder vollständige Play-Strength-Freigabe. Der aktuelle Folgeplan liegt unter `docs/architecture/ai/proteus-ai-release-reconciliation-plan-2026-07-09.md`.
