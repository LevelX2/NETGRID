...
`docs/releases/proteus/` bündelt die Artefakte für den importierten Proteus-Kartenstand. Import, Coverage, Slicing und Mechanikverträge bleiben die führenden Handoffs; seit Phase 1a, 1b, 1d und 1g gibt es zusätzlich eine eng begrenzte Runtime-Freigabe für zehn Baseline-Karten. Proteus ist weiterhin nicht decklegal, nicht formatlegal und nicht AI-unterstützt.
