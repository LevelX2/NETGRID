...
`docs/releases/proteus/` bündelt die Artefakte für den importierten Proteus-Kartenstand. Import, Coverage, Slicing und Mechanikverträge bleiben die führenden Handoffs; die abgeschlossenen Detail-Slices geben einzelne Karten beziehungsweise Foundations eng begrenzt für die Runtime frei. Nach PRO017-2 stehen 144 von 154 Proteus-Karten als konkrete CardImplementation-Dateien bereit; 10 fehlen noch. Proteus ist weiterhin nicht decklegal, nicht formatlegal und nicht AI-unterstützt.
