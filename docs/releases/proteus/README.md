...
`docs/releases/proteus/` bündelt die Artefakte für den importierten Proteus-Kartenstand. Import, Coverage, Slicing und Mechanikverträge bleiben die führenden Handoffs; die abgeschlossenen Detail-Slices geben einzelne Karten beziehungsweise Foundations eng begrenzt für die Runtime frei. Nach PRO018 stehen 146 von 154 Proteus-Karten als konkrete CardImplementation-Dateien bereit; 8 fehlen noch. Proteus ist weiterhin nicht decklegal, nicht formatlegal und nicht AI-unterstützt.
...
Proteus bleibt außerhalb explizit abgeschlossener Implementierungsslices blockiert. Abgeschlossen sind die Done-Activities für Phase 1a, 1b, 1d, 1g, 2a bis 2d, 3a bis 3c, 3e, 4a, 5b, 7a bis 7d, 8a bis 8f, 9d sowie PRO007, PRO008, PRO009, PRO009-1, PRO009-2, PRO010, PRO010-1, PRO011, PRO011-1, PRO012, PRO012-1, PRO013, PRO013-1, PRO014, PRO014-1, PRO014-2, PRO015, PRO015-1, PRO016, PRO016-1, PRO017, PRO017-1, PRO017-2 und PRO018. Die freigegebenen Karten sind `human_playable`, aber nicht `deck_legal`, nicht `format_legal` und nicht `ai_supported`. PRO017 ergänzt sechs Action-Economy-/Action-Debt-Karten mit optionalen restricted extra actions, forced runner actions, future action grants, PDCA-Countern und Corp-Credit-Forfeit-Debt. PRO017-1 härtet PDCA als Choice statt Auto-Replacement, turn-bound Grant-Ablauf und Viacox-"nicht möglich"-Resolve. PRO017-2 restauriert den ursprünglichen PDCA-Timing-Kontext nach `pass`/`replace`, hängt PDCA konsistent nach bestehenden Replacement-/Event-Modification-Fenstern an verbleibenden Corp-Damage und schließt Runner-self-/Core-Damage weiter aus. PRO018 setzt `Hijack` und `Test Spin` mit runnerprivaten Hidden-Zone-Installationschoices, temporären Installationscredits, deterministischem Shuffle, Run-Followup und Return-or-Penalty-Cleanup um. Der Harness steht bei 154/146/8 ohne Drift. Jeder spätere Slice braucht eigene Requirements, Tests und Gate-Nachweise. Die übrigen Phase-Activities bleiben entlang von `detailed-phase-slice-plan-2026-05-24.md` weiter zu bearbeiten.
