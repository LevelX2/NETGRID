...
Proteus bleibt außerhalb explizit abgeschlossener Implementierungsslices blockiert. Abgeschlossen sind die Done-Activities für Phase 1a, 1b, 1d, 1g, 2a bis 2d, 3a bis 3c, 3e, 4a, 5b, 7a bis 7d, 8a bis 8f, 9d sowie PRO007, PRO008, PRO009, PRO009-1, PRO009-2, PRO010, PRO010-1, PRO011, PRO011-1, PRO012, PRO012-1, PRO013, PRO013-1, PRO014, PRO014-1, PRO014-2, PRO015, PRO015-1, PRO016, PRO016-1 und PRO017. Die freigegebenen Karten sind `human_playable`, aber nicht `deck_legal`, nicht `format_legal` und nicht `ai_supported`. PRO017 ergänzt sechs Action-Economy-/Action-Debt-Karten mit optionalen restricted extra actions, forced runner actions, future action grants, PDCA-Countern und Corp-Credit-Forfeit-Debt. Der Harness steht danach bei 154/144/10 ohne Drift. Jeder spätere Slice braucht eigene Requirements, Tests und Gate-Nachweise. Die übrigen Phase-Activities bleiben entlang von `detailed-phase-slice-plan-2026-05-24.md` weiter zu bearbeiten.
...
Phase 9b ist durch PRO017 erledigt. Die alte Activity `docs/activities/in-progress/act-2026-05-24-proteus-phase-9b-action-economy-debt.md` bleibt nur als Referenz; die Zählung erfolgt über `docs/activities/done/act-2026-05-28-proteus-pro017-action-economy-debt-suite.md`.
