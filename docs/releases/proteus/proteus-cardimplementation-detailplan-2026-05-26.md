...
- Aktueller Stand nach `PRO011`: 105 konkrete Proteus-CardImplementation-Dateien.
- Fehlende konkrete CardImplementation-Dateien: 49.
...
| PRO011 | Hidden Resource Economy/Access Suite | `Chiba Bank Account`, `Liberated Savings Account`, `Swiss Bank Account`, `Airport Locker`, `HQ Mole`, `R&D Mole`, `Simulacrum`, `Time to Collect` | Erledigt: acht verdeckte Runner-Resources als konkrete CardImplementation-Dateien umgesetzt; generische Tap-/Reveal-Kosten, Run-/Encounter-Bedingungen, Access-Count-Erhöhung, AP-ICE-Pass und Resource-Trash-Prevention ergänzt. Die alten Phase-4b/4c-Scope-Blocker bleiben nur Statusreferenzen ohne doppelte Zählung. | Acht Dateien; Hidden-Info-Redaction, Tap-/Kosten-Revalidierung, Access-Count, Encounter-Search-/Pass-Fenster, Trash-Prevention und Harness 154/105/49 ohne Drift. |
