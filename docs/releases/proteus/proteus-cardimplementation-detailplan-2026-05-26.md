...
- Aktueller Stand nach `PRO013`: 121 konkrete Proteus-CardImplementation-Dateien.
- Fehlende konkrete CardImplementation-Dateien: 33.
...
| PRO013 | Agenda/Steal/Overadvance Suite | `Corporate Headhunters`, `Fetal AI`, `Marked Accounts`, `Project Zurich`, `World Domination`, `Blackmail`, `Pirate Broadcast`, `Promises, Promises` | Erledigt: Score-/Steal-Fenster, current-access Self-Steal-Cost, Agenda-Access-Ambush, fixe und einmalige Agenda-Punktmodifikatoren, Overadvance-Start-of-Turn-Credits, Runner-Agenda-Event-Gewinne und deterministische Mehrfach-Run-Sequenzen mit Action-Debt generisch umgesetzt. Die alten Phase-6a/6e-Scope-Blocker bleiben nur Statusreferenzen ohne doppelte Zählung. | Acht Dateien; Score-/Steal-/Access-Replacement-, Agenda-Point- und Action-Debt-Gates; Harness 154/121/33 ohne Drift. |
