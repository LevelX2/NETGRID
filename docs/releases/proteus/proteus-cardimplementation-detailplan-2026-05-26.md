...
Dieser Plan ist der führende Zuschnitt für die weitere Proteus-CardImplementation-Arbeit. Er bündelt die Restarbeit ab `PRO007` bewusst in größere Mechanikfamilien, damit ein Umsetzungspaket mehrere fachlich nahe Karten und die dafür ohnehin nötigen generischen Engine-Bausteine zusammen liefert.

## Ausgangslage

- Proteus-Gesamtbasis: 154 Karten in `data/cards/proteus-cards.json`.
- Aktueller Stand nach `PRO007`: 67 konkrete Proteus-CardImplementation-Dateien.
- Fehlende konkrete CardImplementation-Dateien: 87.
...
| PRO008 | Runner Event Run/Economy/Followup Suite | `On the Fast Track`, `Prearranged Drop`, `Back Door to Rivals`, `Runner Sensei`, `All-Hands`, `Rush Hour`, `Decoy Signal`, `Demolition Run`, `Remote Detonator`, `Disgruntled Ice Technician`, `Drone for a Day`, `Reconnaissance`, `Weefle Initiation` | Runner-Event-Run-Flags, History, Trace-Rewards, Access-/Run-Replacement, Derez-/Trash-/Rez-Followups und temporäre Event-Boni zusammenhängend umsetzen. | Dreizehn Dateien; Event-Run-Lifecycle-, Followup-, History-, Hidden-Info- und Replay-Gates. |
| PRO009 | Runner Icebreaker Choice/Modifier Suite | `Black Widow`, `Fubar`, `Morphing Tool`, `Bulldozer`, `Lockjaw`, `Personal Touch, The`, `Eurocorpse (TM) Spin Chip` | Install-/Choice-State für Breaker-Ziele/Subtypes, rungebundene Breaker-Folgeeffekte, Supportprogramme, permanente Strength-Counter und hostgebundene Zahlungsbits. | Sieben Dateien; Choice-Revalidierung, host-/source-bound Modifier, Run-Ende-Cleanup und Breaker-Regressionen. |
| PRO010 | Corp ICE Trace/Conditional/Lifecycle Suite | `Chihuahua`, `Coyote`, `Iceberg`, `Washed-Up Solo Construct`, `Datacomb`, `Death Yo-Yo`, `Marionette`, `Scaffolding`, `Tumblers`, `Twisty Passages` | Trace-Erfolge mit Prevention/Marge, Pay-or-trash, Future-ICE-Modifier, variable/conditional ICE-Details sowie Post-Pass-/Derez-/Reposition-Lifecycle in einem ICE-Paket. | Zehn Dateien; Encounter-, Trace-, Zahlungs-, Reposition-, Lifecycle-, PublicPayload- und Replay-Tests. |
| PRO011 | Hidden Resource Economy/Access Suite | `Chiba Bank Account`, `Liberated Savings Account`, `Swiss Bank Account`, `Airport Locker`, `HQ Mole`, `R&D Mole`, `Simulacrum`, `Time to Collect` | Verdeckte Economy-/Cost-/Penalty-Fenster, Access-Start-Modifikatoren, Mole-Fenster und Simulacrum-/Encounter-Folgeeffekte mit runnerprivater Auswahl. | Acht Dateien; Hidden-Info-Redaction, Cost-Revalidierung, Access-Count und PlayerView-Grenzen. |
| PRO012 | Hidden Resource Prevention/Sabotage Suite | `Bolt-Hole`, `Expendable Family Member`, `Back Door to Netwatch`, `Get Ready to Rumble`, `Wired Switchboard`, `Credit Subversion`, `Death from Above`, `Mercenary Subcontract` | Hidden-Reveal-and-trash-Kosten, Prevention, Trace-Cancel, Post-Damage-Reaktion, Successful-Run-/Current-Access-Sabotage und aktuelle Access-Zielauswahl. | Acht Dateien; Reveal-, Timing-, Target-, Random-Discard-, PublicPayload- und Replay-/StateHash-Tests. |
| PRO013 | Agenda/Steal/Overadvance Suite | `Corporate Headhunters`, `Fetal AI`, `Marked Accounts`, `Project Zurich`, `World Domination`, `Blackmail`, `Pirate Broadcast`, `Promises, Promises` | Score-/Steal-Fenster, Self-Steal-Cost, Agenda-Punkt-Modifikatoren, Overadvance-Credits, Runner-Agenda-Events und Mehrfach-Run-Sequenzen zusammenführen. | Acht Dateien; Score-/Steal-/Access-Replacement-, Agenda-Point- und Action-Debt-Gates. |
| PRO014 | Corp Asset/Upgrade Utility Suite | `Department of Misinformation`, `Government Contract`, `LDL Traffic Analyzers`, `Panic Button`, `Cybertech Think Tank`, `Raymond Ellison`, `Siren`, `Syd Meyer Superstores` | Asset-/Upgrade-Fenster für Expose-Verhinderung, advancementbasierte Damage-Boosts, temporäre Credits, Install-/Run-Kontexte, Redirects und Corp-Trash eigener ICE. | Acht Dateien; Aktivierungs-, Kosten-, Ziel-, Redirect-, Hidden-Info- und Replay-Gates. |
