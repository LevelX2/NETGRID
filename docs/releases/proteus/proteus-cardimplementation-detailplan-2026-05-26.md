...
Dieser Plan ist der führende Zuschnitt für die weitere Proteus-CardImplementation-Arbeit. Er bündelt die Restarbeit ab `PRO009` bewusst in größere Mechanikfamilien, damit ein Umsetzungspaket mehrere fachlich nahe Karten und die dafür ohnehin nötigen generischen Engine-Bausteine zusammen liefert.

## Ausgangslage

- Proteus-Gesamtbasis: 154 Karten in `data/cards/proteus-cards.json`.
- Aktueller Stand nach `PRO008`: 80 konkrete Proteus-CardImplementation-Dateien.
- Fehlende konkrete CardImplementation-Dateien: 74.
