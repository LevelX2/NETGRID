...
| PRO006 | Simple Corp ICE Resolver | `Brain Wash`, `Colonel Failure`, `Misleading Access Menus`, `Snowbank` | Nur vorhandene Printed-Subroutine-, Lifecycle- und Riddler-Muster verwenden; Karten mit Trace-/Future-Modifier bleiben draußen. | Vier Dateien, Subroutine-Tests plus Replay/StateHash. |
