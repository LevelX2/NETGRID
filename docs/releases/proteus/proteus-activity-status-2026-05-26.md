...
| --- | ---: | --- |
| `done + implemented/foundation` | 25 | Erledigte Runtime- oder Foundation-Slices; Implementierungsfortschritt wird trotzdem nur über Dateien plus Registry gezählt. |
...
| Gesamt | 70 | Proteus-Activity-Dateien im Board. |
