...
| Fehlende konkrete CardImplementation-Dateien | 16 | Gesamtbasis minus konkrete Dateien |
...
| PRO017 | umgesetzt | 6 Action-Economy-/Action-Debt-Karten; Implementierungszählung 144/154. |
...
| --- | ---: | --- |
| `done + implemented/foundation` | 36 | Erledigte Runtime-, Foundation- oder gezielte Härtungsslices; Implementierungsfortschritt wird trotzdem nur über Dateien plus Registry gezählt. |
...
| PRO017 | umgesetzt | Action Economy/Action Debt Suite mit 6 Karten. |
