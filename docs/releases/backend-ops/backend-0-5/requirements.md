...
Stand: 2026-05-14
Quelle: `docs/releases/backend-ops/backend-0-5/plan.md`
...
| B05-REQ-006 | Wartungsendpunkte bilden eine eigene authentifizierte Control Plane. | Alle Routen verlangen Maintenance-Sitzung; lokales HTTP ist nur auf Loopback zulässig, Remote-Zugriff nur explizit über HTTPS und vertrauenswürdigen Proxy. |
