...
| Psychic Friend | Die gedruckte Dauer "until end of turn" wird als `current_turn`-Pump modelliert. Der stapelbare Bonus bleibt unabhängig von Encounter- und Run-Enden bis zum Ende des Runner-Zuges erhalten. |
