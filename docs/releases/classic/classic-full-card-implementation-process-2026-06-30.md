...
| CLASSIC-04 | 2026-06-30 | grün | `node -e "for (const file of ['data/manifests/classic-card-support.json','data/ai/ai-card-hints-active.json','data/ai/ai-card-hints-compiled.json','data/scenarios/classic-04-runner-program-smoke.json']) JSON.parse(require('fs').readFileSync(file,'utf8'))"`, `corepack pnpm --filter @netgrid/engine typecheck`, `corepack pnpm --filter @netgrid/engine exec vitest run src/card-implementations/definition-descriptors.test.ts src/game/run/runner-breaker-action-execution.test.ts src/game/run/fort-run-side-families.test.ts src/game/run/run-end-cleanup.test.ts src/game/run/encounter-special-windows.test.ts src/game/access/access-flow.test.ts`, `corepack pnpm --filter @netgrid/engine exec vitest run src/card-implementations/coverage.test.ts`, `corepack pnpm check:engine-cardimplementation-architecture-target`, `corepack pnpm check:card-function-abstraction`, `git diff --check` |
| CLASSIC-05 | 2026-06-30 | grün | `node -e "for (const p of ['data/manifests/classic-card-support.json','data/ai/ai-card-hints-active.json','data/ai/ai-card-hints-compiled.json','data/scenarios/classic-05-corp-ice-smoke.json','docs/reviews/ai/aufgabe-042-compiled-hint-runtime-full-report-2026-05-25.json']) JSON.parse(require('node:fs').readFileSync(p,'utf8'))"`, `corepack pnpm --filter @netgrid/engine typecheck`, `corepack pnpm --filter @netgrid/engine exec vitest run src/card-implementations/definition-descriptors.test.ts src/game/payment/corp-rez-cost.test.ts src/game/run/encounter-printed-effects.test.ts src/game/run/encounter-printed-nontrace-effects.test.ts src/game/run/runner-breaker-action-execution.test.ts src/game/run/run-continuation-execution.test.ts src/game/run/run-flow-hosts.test.ts src/game/run/run-rez-window.test.ts src/game/turn/runner-main-actions.test.ts`, `corepack pnpm --filter @netgrid/engine exec vitest run src/card-implementations/coverage.test.ts`, `corepack pnpm check:engine-cardimplementation-architecture-target`, `node scripts/check-card-name-leakage-in-runtime.mjs --write-report`, `corepack pnpm check:card-function-abstraction`, `corepack pnpm check:ai-compiled-hints`, `git diff --check` |
| CLASSIC-06 | 2026-06-30 | grün | `node -e "for (const p of ['data/manifests/classic-card-support.json','data/ai/ai-card-hints-active.json','data/ai/ai-card-hints-compiled.json','data/scenarios/classic-06-run-redirect-ice-smoke.json','docs/reviews/ai/aufgabe-042-compiled-hint-runtime-full-report-2026-05-25.json']) JSON.parse(require('node:fs').readFileSync(p,'utf8'))"`, `corepack pnpm --filter @netgrid/engine typecheck`, `corepack pnpm --filter @netgrid/engine exec vitest run src/game/run/encounter-printed-nontrace-effects.test.ts src/game/run/run-continuation-execution.test.ts src/game/run/fort-pass-window.test.ts src/game/payment/corp-rez-cost.test.ts src/game/rez/rez-card.test.ts src/game/install/install-card.test.ts src/game/install/corp-ice-install-restrictions.test.ts src/game/choices/pending-choice-resolution.test.ts`, `corepack pnpm --filter @netgrid/engine exec vitest run src/card-implementations/definition-descriptors.test.ts src/card-implementations/coverage.test.ts`, `corepack pnpm check:engine-cardimplementation-architecture-target`, `node scripts/check-card-name-leakage-in-runtime.mjs --write-report`, `corepack pnpm check:card-function-abstraction`, `corepack pnpm check:ai-compiled-hints`, `git diff --check` |
| CLASSIC-08 | 2026-06-30 | grün | `node -e "for (const f of ['data/manifests/classic-card-support.json','data/ai/ai-card-hints-active.json','data/ai/ai-card-hints-compiled.json','data/scenarios/classic-08-corp-assets-upgrades-smoke.json']) { JSON.parse(require('fs').readFileSync(f,'utf8')); }"`, `corepack pnpm --filter @netgrid/engine typecheck`, `corepack pnpm --filter @netgrid/engine exec vitest run src/index-tests/mechanics/classic-corp-assets-upgrades.test.ts`, `corepack pnpm --filter @netgrid/engine exec vitest run src/game/run/successful-run-interventions.test.ts src/game/run/run-flow-hosts.test.ts src/game/access/access-effect-handlers.test.ts src/game/card-implementation/card-implementation-runtime-deps.test.ts`, `corepack pnpm --filter @netgrid/engine exec vitest run src/card-implementations/coverage.test.ts src/card-implementations/definition-descriptors.test.ts`, `corepack pnpm build:ai-compiled-hints`, `corepack pnpm check:ai-compiled-hints`, `node scripts/check-card-name-leakage-in-runtime.mjs --write-report`, `corepack pnpm check:card-function-abstraction`, `git diff --check` |
| CLASSIC-09 | 2026-06-30 | grün | `corepack pnpm --filter @netgrid/engine typecheck`, `corepack pnpm --filter @netgrid/engine exec vitest run src/index-tests/mechanics/classic-runner-rest-cards.test.ts`, `corepack pnpm --filter @netgrid/engine exec vitest run src/card-implementations/coverage.test.ts src/card-implementations/definition-descriptors.test.ts`, `corepack pnpm check:ai-compiled-hints`, `corepack pnpm check:engine-cardimplementation-architecture-target`, `node scripts/check-card-name-leakage-in-runtime.mjs --write-report`, `corepack pnpm check:card-function-abstraction`, `git diff --check` |
| CLASSIC-10 | 2026-06-30 | grün | `node -e "for (const p of ['data/ai/ai-card-hints-active.json','data/ai/ai-card-hints-compiled.json','data/ai/ai-deck-pool-1.0.1.json','data/decks/deck-snapshots-0.8.json','data/manifests/classic-card-support.json','data/scenarios/card-support-ai-supported-current.json','data/scenarios/classic-07-agenda-smoke.json','data/scenarios/classic-09-runner-rest-smoke.json']) { JSON.parse(require('fs').readFileSync(p,'utf8')); }"`, `corepack pnpm build:ai-compiled-hints`, `corepack pnpm check:ai-compiled-hints`, `corepack pnpm --filter @netgrid/catalog exec vitest run src/index.test.ts`, `corepack pnpm --filter @netgrid/decks exec vitest run src/index.test.ts`, `corepack pnpm --filter @netgrid/ai exec vitest run src/index.test.ts -t "Classic AI snapshots|V1.2.3 cards out|marks every active support AI group"`, `corepack pnpm --filter @netgrid/catalog typecheck`, `corepack pnpm --filter @netgrid/decks typecheck`, `corepack pnpm --filter @netgrid/ai typecheck`, `corepack pnpm --filter @netgrid/engine exec vitest run src/card-implementations/coverage.test.ts src/card-implementations/definition-descriptors.test.ts`, `corepack pnpm check:engine-cardimplementation-architecture-target`, `git diff --check` |
| CLASSIC-11 | 2026-06-30 | grün | `corepack pnpm typecheck`, `corepack pnpm --filter @netgrid/engine exec vitest run src/index-tests/mechanics/classic-agendas.test.ts src/index-tests/mechanics/classic-corp-assets-upgrades.test.ts src/index-tests/mechanics/classic-runner-rest-cards.test.ts src/card-implementations/coverage.test.ts src/card-implementations/definition-descriptors.test.ts`, `corepack pnpm --filter @netgrid/catalog exec vitest run src/index.test.ts`, `corepack pnpm --filter @netgrid/decks exec vitest run src/index.test.ts`, `corepack pnpm --filter @netgrid/ai exec vitest run src/index.test.ts -t "Classic AI snapshots|V1.2.3 cards out|marks every active support AI group"`, `corepack pnpm check:ai-compiled-hints`, `corepack pnpm check:engine-cardimplementation-architecture-target`, `corepack pnpm check:card-function-abstraction`, `git diff --check` |
