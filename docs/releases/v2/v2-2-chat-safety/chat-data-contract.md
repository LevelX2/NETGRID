...
Der konkrete Redaction- und Boundary-Testvertrag liegt in `docs/releases/v2/v2-2-chat-safety/chat-redaction-boundary-test-plan.md`. Er konkretisiert Reconnect-, WebSocket-, Server-Payload-, Replay-/StateHash-, AIInput-/DecisionDebug- und Log-Checks, ohne Chat-Implementierung, Public-Chat, Moderationskonsole oder LLM-Moderation freizugeben.
