...
Quellenlinks sind in `docs/releases/mvp/mvp-0-91-card-images/card-image-asset-gate-spec.md` und `data/card-assets/card-image-source-registry-0.91.json` dokumentiert.
...
| V091-MUST-016 | Must-Testabdeckung | Jede Must-Anforderung ist in `docs/releases/mvp/mvp-0-91-card-images/test-matrix.md` abgedeckt. | V091-T016 |
