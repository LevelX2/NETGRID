...
Der V0.91 Requirements Freeze ist abgeschlossen. Die Anforderungen für Asset-Gate, Quelle, Nutzungsentscheidung, lokalen Cache, Bildmetadaten, APIs, UI-Orte, Fallbacks und Hidden-Info-Grenzen sind testbar formuliert. Jede Must-Anforderung hat Testabdeckung in `docs/releases/mvp/mvp-0-91-card-images/test-matrix.md`.
