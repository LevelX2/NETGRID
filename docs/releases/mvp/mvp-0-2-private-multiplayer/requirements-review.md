...
|---|---|---|
| MVP 0.1 Gate bestanden. | pass | `docs/releases/mvp/mvp-0-1-local-core/final-review.md` |
| Keine Kartenpool-Erweiterung. | pass | Baseline 0.2 bleibt bei `cardImplementationVersion: 0.1.0`. |
| Jede Must-Anforderung hat Testabdeckung. | pass | `docs/releases/mvp/mvp-0-2-private-multiplayer/multiplayer-test-matrix.md` |
