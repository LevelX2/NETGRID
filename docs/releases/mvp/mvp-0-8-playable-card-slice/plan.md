...
|---|---|---|
| V08-MUST-001 | V0.8 Requirements Freeze | `docs/releases/mvp/mvp-0-8-playable-card-slice/requirements.md` definiert Slice, Nicht-Ziele, Gates, Artefakte und Abnahmekriterien. |
...
- geplanter V0.8-Golden-Hash-Review als späteres Pflichtartefakt
...
- `docs/releases/mvp/mvp-0-1-local-core/deviation-registry.md` (historische Abweichungsdokumentation)
...
| V08-O-011 | Golden-Hash-Reviewdatei | Einen V0.8-Golden-Hash-Review als Pflichtartefakt verwenden. |
