...
|---|---|---|
| V05-MUST-001 | Import-Spezifikation | `docs/releases/mvp/mvp-0-5-card-import-catalog/card-import-spec.md` beschreibt Quelle, Snapshot, Normalisierung, Nutzungsgrenzen und Update-Regeln. |
