...
| `docs/releases/mvp/mvp-0-92-mechanics-inventory/requirements-review.md` | ja | Review gegen Scope, Quellenpriorität, Hidden-Info-Regeln und Implementierbarkeit. |
| `docs/releases/mvp/mvp-0-92-mechanics-inventory/final-review.md` | ja | Gate-Ergebnis und explizite Freigabe oder Blocker für V0.93. |
