...
Die Scope-Entscheidung wurde nachgelagert in `docs/releases/mvp/roadmaps/post-mvp-0-4-roadmap.md` getroffen. Der nächste Gate-Schritt ist MVP 0.5 Kartenimport und Kartenkatalog; UI-Neugestaltung und Designgestaltung sind bewusst V0.7 zugeordnet.
