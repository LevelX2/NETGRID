...
3. Für jede Karte wird mindestens ein deterministischer Human-Fall, ein Edge-Fall und ein KI-Fall in `docs/releases/v1/v1-9-originalset-completion/v1-9-9-pre-sprint/test-matrix.md` vorgesehen.
