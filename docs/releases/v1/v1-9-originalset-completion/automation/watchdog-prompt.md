...
Historischer Hinweis 2026-05-17: Der Watchdog ist laut `docs/releases/v1/v1-9-originalset-completion/automation/state.md` gelöscht beziehungsweise nicht aktiv. Dieser Prompt bleibt nur als Evidence für damalige Watchdog-Regeln erhalten.
...
- Existiert der Cursor `docs/releases/v1/v1-9-originalset-completion/automation/state.md`?
...
- die Completion-Automation mit dem Prompt aus `docs/releases/v1/v1-9-originalset-completion/automation/prompt.md` neu anlegen, falls sie fehlt und keine gleichwertige aktive Automation existiert
...
- einen Blockerbericht in `docs/releases/v1/v1-9-originalset-completion/automation/watchdog-report.md` schreiben oder aktualisieren
- `docs/releases/v1/v1-9-originalset-completion/automation/state.md` nur fuer Watchdog-Befunde, Blocker und Rettungsstatus aktualisieren
