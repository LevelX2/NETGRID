...
2. Lies danach:
   ...
   - `docs/releases/v1/v1-9-originalset-completion/display-text-finalization-policy.md`
...
6. Lies den aktuellen Release und die Phase aus `docs/releases/v1/v1-9-originalset-completion/automation/state.md`.
