...
- `docs/releases/v1/v1-9-originalset-completion/v1-9-18-generic-upgrade-root-server/plan.md`, `V1_9_18_REQUIREMENTS.md`, `V1_9_18_GENERIC_UPGRADE_ROOT_SERVER_SPEC.md`, `V1_9_18_TEST_MATRIX.md` und `V1_9_18_REQUIREMENTS_REVIEW.md` frieren den ersten V1.9.18-Scope ein.
...
Die Kartentexte werden nach `docs/releases/v1/v1-9-originalset-completion/display-text-finalization-policy.md` aus lokal bestätigten Regelkern-Aussagen in der V1.9.10-bis-V1.9.xx-Matrix abgeleitet. Sie sind display-only und keine Regel-, Parser-, KI-, Replay- oder StateHash-Autorität.
