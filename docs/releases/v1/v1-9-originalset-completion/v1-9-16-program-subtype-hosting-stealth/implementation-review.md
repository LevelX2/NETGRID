...
- `docs/releases/v1/v1-9-originalset-completion/v1-9-16-program-subtype-hosting-stealth/plan.md`, `V1_9_16_REQUIREMENTS.md`, `V1_9_16_PROGRAM_SUBTYPE_HOSTING_STEALTH_SPEC.md`, `V1_9_16_TEST_MATRIX.md` und `V1_9_16_REQUIREMENTS_REVIEW.md` frieren den Scope ein.
