...
Die V1.9.16-Kartentexte sind finale display-only Texte aus lokal bestaetigten Regelkern-Aussagen nach `docs/releases/v1/v1-9-originalset-completion/display-text-finalization-policy.md`. Kartentext bleibt keine Parser-, Engine-, LegalAction-, KI-, Replay- oder StateHash-Autoritaet.
