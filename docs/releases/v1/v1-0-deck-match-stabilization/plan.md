...
V1.0 ist implementiert und lokal verifiziert. Das Ergebnis ist zusätzlich in `docs/releases/v1/v1-0-deck-match-stabilization/final-review.md` dokumentiert.
