...
Dieses Dokument ist ab jetzt das Kandidaten- und Herkunftsdokument, nicht der kanonische Detailumfang fuer V1.0.4. Der kanonische V1.0.4-Scope ist `docs/releases/v1/v1-0-4-private-match-lifecycle/plan.md`.
...
Der Requirements-Freeze wurde in `docs/releases/v1/v1-0-4-private-match-lifecycle/requirements.md` festgehalten. Umsetzung soll auf `docs/releases/v1/v1-0-4-private-match-lifecycle/plan.md` und `docs/releases/v1/v1-0-4-private-match-lifecycle/requirements.md` basieren.
