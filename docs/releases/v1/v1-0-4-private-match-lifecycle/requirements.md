...
Dieses Dokument friert die V1.0.4-Anforderungen für Private Match Lifecycle und Session Recovery ein. Es ergänzt den kanonischen Plan `docs/releases/v1/v1-0-4-private-match-lifecycle/plan.md` und ist vor der Umsetzung verbindlich zu beachten.
