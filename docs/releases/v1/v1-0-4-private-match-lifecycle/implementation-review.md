...
`docs/releases/v1/v1-0-4-private-match-lifecycle/next-release-candidates.md` bleibt Kandidaten- und Herkunftsdokument, ist aber keine gleichrangige Implementierungsspezifikation.
...
- Wiederholbarer Zwei-Tab-Smoke dokumentiert in `docs/releases/v1/v1-0-4-private-match-lifecycle/two-tab-smoke.md`.
