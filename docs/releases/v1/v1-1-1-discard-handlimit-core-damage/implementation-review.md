...
- `docs/releases/v1/v1-1-1-discard-handlimit-core-damage/requirements-review.md`
...
Die V1.1.1-Testmatrix ist durch Engine-, Server-, AI-, Web-, Visibility- und E2E-Regressionen abgedeckt. Der finale Gate-Lauf ist in `docs/releases/v1/v1-1-1-discard-handlimit-core-damage/final-review.md` dokumentiert.
