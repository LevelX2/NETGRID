...
V1.1.0 hat Setup, Mulligan, 7-Punkte-Ziel, Game-End-Vertrag, Identity-PlayerViews und Archives-facedown-Grundlage umgesetzt. In `docs/releases/v1/v1-1-0-setup-game-end-m2/plan.md` ist Discard/Handlimit/Core Damage ausdrücklich als V1.1.1-Folgegate markiert.
