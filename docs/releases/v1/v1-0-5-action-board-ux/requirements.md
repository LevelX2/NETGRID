...
Dieses Dokument friert die V1.0.5-Anforderungen für Action Board UX und Board-Klarheit ein. Es ergänzt den kanonischen Detailplan `docs/releases/v1/v1-0-5-action-board-ux/plan.md` und macht den Scope testbar.
...
- `corepack pnpm build`
- `git diff --check`
- V1.0.5 Browser-/Playtest-Smoke nach `docs/releases/v1/v1-0-5-action-board-ux/browser-playtest-smoke.md`
