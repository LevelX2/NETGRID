...
| V105-T022 | Browser/Playtest Runbook | V105-MUST-011 | `docs/releases/v1/v1-0-5-action-board-ux/browser-playtest-smoke.md` existiert und enthält wiederholbare Schritte für KI, zwei Tabs, verdeckte Installation, Run, Reconnect und schmalen Viewport. |
...
- `corepack pnpm build`
- `git diff --check`
- V1.0.5 Browser-/Playtest-Smoke aus `docs/releases/v1/v1-0-5-action-board-ux/browser-playtest-smoke.md`
...
Alle Must-Anforderungen aus `docs/releases/v1/v1-0-5-action-board-ux/requirements.md` haben mindestens eine Testspur in dieser Matrix.
