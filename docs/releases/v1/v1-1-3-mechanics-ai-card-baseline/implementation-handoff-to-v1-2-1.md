...
- `docs/releases/v1/v1-2-0-event-modification/requirements-review.md`
...
- `docs/releases/v1/v1-2-1-replacement-effects/requirements-review.md`
...
- docs/releases/v1/v1-1-3-mechanics-ai-card-baseline/implementation-handoff-to-v1-2-1.md
- docs/releases/v1/v1-2-0-event-modification/plan.md
- docs/releases/v1/v1-2-0-event-modification/requirements.md
- docs/releases/v1/v1-2-0-event-modification/spec.md
- docs/releases/v1/v1-2-0-event-modification/test-matrix.md
