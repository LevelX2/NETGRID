...
| Artefakt | Rolle |
| --- | --- |
| `docs/releases/v1/v1-1-3-mechanics-ai-card-baseline/plan.md` | Baseline-Plan, Scope, No-Scope, Mechanik-Coverage, Kartenmapping, AI-Level-Audit und KI-Sollverträge. |
| `docs/releases/v1/v1-1-3-mechanics-ai-card-baseline/requirements.md` | eingefrorene Must-/Should-Anforderungen V113-MUST-001 bis V113-MUST-022. |
