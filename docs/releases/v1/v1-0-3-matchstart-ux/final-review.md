...
- Spiel/Lobby abbrechen, aktives Aufgeben und sichtbarere Gegnernamen sind bewusst nicht Teil von V1.0.3; sie sind als V1.0.4-Kandidaten in `docs/releases/v1/v1-0-4-private-match-lifecycle/next-release-candidates.md` gesammelt.
