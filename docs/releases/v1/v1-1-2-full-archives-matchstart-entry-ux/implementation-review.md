...
Die V1.1.2-Testmatrix ist durch gezielte Engine-, Server-, Web-, Visibility- und Browser-E2E-Regressionen abgedeckt. Der finale Gate-Lauf ist in `docs/releases/v1/v1-1-2-full-archives-matchstart-entry-ux/final-review.md` dokumentiert.
