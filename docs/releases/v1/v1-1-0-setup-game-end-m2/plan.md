...
Dieses Dokument plante die Gesamtheit des Releases `V1.1.0 Setup/Game-End M2` in maximaler fachlicher und technischer Detailtiefe vor der Freigabe. Die Umsetzung ist am 2026-05-07 erfolgt und in `docs/releases/v1/v1-1-0-setup-game-end-m2/implementation-review.md` sowie `docs/releases/v1/v1-1-0-setup-game-end-m2/final-review.md` dokumentiert.
...
- `docs/releases/v1/v1-1-0-setup-game-end-m2/plan.md` nach Review/Freigabe in `approved` überführen.
