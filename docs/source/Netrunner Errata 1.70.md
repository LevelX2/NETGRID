...
@Ice is installed _ON_ a data fort. Agenda, nodes, and
upgrades are installed _IN_ a data fort. (Wendy
...
ice which modifies its strength. 2) Corp: Apply any other special effect which changes the
...
of the encountered piece of ice. 4) Runner: When you want to break any subroutines on this
