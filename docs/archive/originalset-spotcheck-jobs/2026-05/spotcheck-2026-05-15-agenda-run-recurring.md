...
- Deduplizierung erfolgte gegen `docs/reviews/originalset-spotchecks/register.md`, `data/reports/originalset-card-spotcheck-register.json` und alle Markdown-Jobberichte unter `docs/derived/originalset-spotcheck-jobs/inbox`, `in_progress`, `done` und `blocked`.
...
Detailbericht: `docs/reviews/originalset-spotchecks/reports/ORIGINALSET_CARD_SPOTCHECK_2026_05_15_AGENDA_RUN_RECURRING_IMPLEMENTATION.md`
...
Queue-Hinweis: Die kanonische Done-Kopie liegt unter `docs/archive/originalset-spotcheck-jobs/2026-05/`.
