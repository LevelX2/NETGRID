...
Dieser Generatorlauf hat zuerst die Queue-Berichte unter `docs/derived/originalset-spotcheck-jobs/inbox/`, `in_progress/`, `done/` und `blocked/` sowie `docs/reviews/originalset-spotchecks/register.md` und `data/reports/originalset-card-spotcheck-register.json` gelesen. Eine Karte wurde ausgeschlossen, sobald ihre Card ID in einer dieser Quellen vorkam.
...
- `docs/reviews/originalset-spotchecks/reports/ORIGINALSET_CARD_SPOTCHECK_2026_05_15_TAGGED_WALL_BREAKER_IMPLEMENTATION.md`
