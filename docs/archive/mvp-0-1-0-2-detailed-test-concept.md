# NETGRID-Webapplikation – Detailliertes Testkonzept
...
Dieses Testkonzept definiert, wie die NETGRID-Webapplikation für den MVP-Umfang belastbar geprüft wird. Es behandelt zwei Stufen:
