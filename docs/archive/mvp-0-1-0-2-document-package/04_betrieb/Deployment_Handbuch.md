# NETGRID-Webapplikation – Deployment-Handbuch für privaten Betrieb
...
```env
NODE_ENV=production
APP_BASE_URL=https://netgrid.example.internal
SERVER_PORT=3000
DATABASE_URL=file:/app/data/netgrid.sqlite
...
TRUST_PROXY=true
ALLOWED_ORIGINS=https://netgrid.example.internal
```
