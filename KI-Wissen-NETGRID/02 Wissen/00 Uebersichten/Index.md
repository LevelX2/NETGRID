...
- V1.9.12 Counter/Virus/Purge/Recurring ist in Umsetzung. Der erste WIP umfasst Detailplan, Requirements, Spec, Testmatrix, Requirements Review, Implementation Review, WIP-Szenario, Engine-Runtime-Definitionen fuer alle elf Zielkarten sowie WIP-Manifest, Mechanics-Coverage, AI-Hints, AI-Smoke-Plan und AI-Approval-Manifest. Der Katalog fuehrt die elf Karten als WIP-Zielmenge und prueft Artefaktparitaet plus No-Promotion-Guard. JSON-Validation, Engine (213), Catalog (27), AI (84), Server (72), Web (76), Typecheck, Test, Lint und Build sind grün; der Build zeigt nur die bekannte nicht-blockierende Turbopack-NFT-Warnung. `docs/derived/V1_9_12_FINALIZATION_BLOCKER.md` dokumentiert den harten Text-/Finalisierungblocker; finale Catalog/Web-Promotion, Final Review und Webclient-Version bleiben offen. Der Automation-Cursor steht auf V1.9.12 `implementing`.
