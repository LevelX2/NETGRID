...
- `docs/derived/V1_9_10_TO_V1_9_22_AUTOMATION_CONTROLLER_PLAN.md`, `docs/derived/V1_9_10_TO_V1_9_22_AUTOMATION_STATE.md`, `docs/derived/V1_9_10_TO_V1_9_22_AUTOMATION_PROMPT.md` und `docs/derived/V1_9_10_TO_V1_9_22_AUTOMATION_WATCHDOG_PROMPT.md`: stündliche Expeditionsmodus-Automation der V1.9.10-bis-V1.9.22-Kette plus stündlicher Watchdog. Nach lokalen ACL-Regressionen auf `.codex`/`.git` laufen die Automationen im festen lokalen Worktree-Modus und nutzen den ignorierten Worktree-Lock `C:\Projekte\NETGRID_AUTOMATION_V1_9_ORIGINALSET\.codex-runlogs\v1_9_originalset_completion.lock`. Worktree-Laeufe duerfen nicht in den lokalen Hauptworkspace `C:\Projekte\NETGRID` zurueckspringen. WIP-Commits und WIP-Pushes auf `codex/v1-9-originalset-completion` sind erlaubt; Releaseabschluss, Kartenaktivierung als vollständig spielbereit und Cursor-Fortschritt bleiben gate-pflichtig.
- V1.9.10 Status-/Manifest-/Katalog-Konsolidierung ist umgesetzt und final reviewt. Keine neue Karte wurde promotet; Manifestparität für Fetch 4.0.1, Hunter und Trojan Horse sowie der Runtime-Statusreport 374/143/143/231 sind grün verifiziert. Führende Artefakte: `docs/derived/V1_9_10_STATUS_MANIFEST_CATALOG_CONSOLIDATION_PLAN.md`, `docs/derived/V1_9_10_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_10_FINAL_REVIEW.md`, `data/manifests/card-implementation-manifest-1.9.10.json`, `data/reports/onr-v1-runtime-status-1.9.10.json`.
- V1.9.11 Hidden-Zone Search/Reveal/Reorder/Shuffle ist umgesetzt und final reviewt. Alle 16 Zielkarten sind `human_playable`, `deck_legal` und `ai_supported`; Manifest, Mechanics-Coverage, Release-Smoke, AI-Hints und AI-Smokes sind versioniert. Führende Artefakte: `docs/derived/V1_9_11_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_11_FINAL_REVIEW.md`, `data/manifests/card-implementation-manifest-1.9.11.json`, `data/rules/mechanics-coverage-1.9.11.json`, `data/scenarios/v1911-hidden-zone-release-smoke.json`, `data/ai/ai-card-hints-deck-legal-v1911.json`, `data/manifests/deck-legal-ai-approval-v1911-manifest.json`, `data/scenarios/ai-deck-legal-v1911-smokes.json`. Der Automation-Cursor wurde nach V1.9.12 weitergesetzt.
- V1.9.12 Counter/Virus/Purge/Recurring ist umgesetzt und final reviewt. Alle elf Zielkarten sind `human_playable`, `deck_legal` und `ai_supported`; finale display-only Kartentexte wurden nach `docs/derived/V1_9_ORIGINALSET_DISPLAY_TEXT_FINALIZATION_POLICY.md` aus lokal bestätigten Regelkern-Aussagen abgeleitet. Führende Artefakte: `docs/derived/V1_9_12_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_12_FINAL_REVIEW.md`, `data/manifests/card-implementation-manifest-1.9.12.json`, `data/rules/mechanics-coverage-1.9.12.json`, `data/scenarios/v1912-counter-virus-recurring-release-smoke.json`, `data/ai/ai-card-hints-deck-legal-v1912.json`, `data/manifests/deck-legal-ai-approval-v1912-manifest.json`, `data/scenarios/ai-deck-legal-v1912-smokes.json`. Der Automation-Cursor wurde nach V1.9.13 weitergesetzt.
- V1.9.13 Damage/Prevention/Avoid/Replacement Longtail ist umgesetzt und final reviewt. Alle 17 Zielkarten sind `human_playable`, `deck_legal` und `ai_supported`; finale display-only Kartentexte wurden nach `docs/derived/V1_9_ORIGINALSET_DISPLAY_TEXT_FINALIZATION_POLICY.md` aus lokal bestätigten Regelkern-Aussagen abgeleitet. Führende Artefakte: `docs/derived/V1_9_13_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_13_FINAL_REVIEW.md`, `data/manifests/card-implementation-manifest-1.9.13.json`, `data/rules/mechanics-coverage-1.9.13.json`, `data/scenarios/v1913-damage-prevention-replacement-smoke.json`, `data/ai/ai-card-hints-deck-legal-v1913.json`, `data/manifests/deck-legal-ai-approval-v1913-manifest.json`, `data/scenarios/ai-deck-legal-v1913-smokes.json`. Der Automation-Cursor wurde nach V1.9.14 weitergesetzt.
- V1.9.14 Trace/Link/Tags/Resource-Tag-Interaktionen ist umgesetzt und final reviewt. Alle 25 Zielkarten sind `human_playable`, `deck_legal` und `ai_supported`; finale display-only Kartentexte wurden aus lokal bestätigten Regelkern-Aussagen abgeleitet. Führende Artefakte: `docs/derived/V1_9_14_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_14_FINAL_REVIEW.md`, `data/manifests/card-implementation-manifest-1.9.14.json`, `data/rules/mechanics-coverage-1.9.14.json`, `data/scenarios/v1914-trace-tag-resource-smoke.json`, `data/ai/ai-card-hints-deck-legal-v1914.json`, `data/manifests/deck-legal-ai-approval-v1914-manifest.json`, `data/scenarios/ai-deck-legal-v1914-smokes.json`.
- V1.9.15 Run Flow, Access, Multiaccess und Ambush on Access ist umgesetzt und final reviewt. Alle 14 Zielkarten sind `human_playable`, `deck_legal` und `ai_supported`; installierte Run-/Access-Helfer sind ueber bestehende Run-, Counter-, Breach- und Hidden-Zone-Barrierepfade abgedeckt. Führende Artefakte: `docs/derived/V1_9_15_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_15_FINAL_REVIEW.md`, `data/manifests/card-implementation-manifest-1.9.15.json`, `data/rules/mechanics-coverage-1.9.15.json`, `data/scenarios/v1915-run-access-multiaccess-smoke.json`, `data/ai/ai-card-hints-deck-legal-v1915.json`, `data/manifests/deck-legal-ai-approval-v1915-manifest.json`, `data/scenarios/ai-deck-legal-v1915-smokes.json`. Der Automation-Cursor wurde nach V1.9.16 weitergesetzt.
- V1.9.16 Program Subtypes, Hosting, Stealth, Worm und Installed-card Destroy ist umgesetzt und final reviewt. Alle 16 Zielkarten sind `human_playable`, `deck_legal` und `ai_supported`; Imp/Bakdoor deckt Daemon-Hosting mit Host-Trash-Kaskade ab, Fragmentation Storm gated Programm-Trash und Net Damage auf Trace-Erfolg, Link-, Stealth- und Recurring-Pfade sind side-sicher und replay-/StateHash-stabil. Führende Artefakte: `docs/derived/V1_9_16_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_16_FINAL_REVIEW.md`, `data/manifests/card-implementation-manifest-1.9.16.json`, `data/rules/mechanics-coverage-1.9.16.json`, `data/scenarios/v1916-program-subtype-hosting-stealth-smoke.json`, `data/ai/ai-card-hints-deck-legal-v1916.json`, `data/manifests/deck-legal-ai-approval-v1916-manifest.json`, `data/scenarios/ai-deck-legal-v1916-smokes.json`. Der Automation-Cursor wurde nach V1.9.17 weitergesetzt.
- V1.9.17 Generische Asset/Node-Fähigkeiten ist umgesetzt und final reviewt. Alle 18 Zielkarten sind `human_playable`, `deck_legal` und `ai_supported`; Economy-/Recurring-/Hosting-/Trace-/Hidden-Zone-/Access-Ambush-/Damage-/Tag-Pfade sind side-sicher und replay-/StateHash-stabil. Cowboy Sysop und Disinfectant, Inc. decken sichtbare installed-card- und Virus-Counter-Zielpfade ab. Führende Artefakte: `docs/derived/V1_9_17_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_17_FINAL_REVIEW.md`, `data/manifests/card-implementation-manifest-1.9.17.json`, `data/rules/mechanics-coverage-1.9.17.json`, `data/scenarios/v1917-generic-asset-node-release-smoke.json`, `data/ai/ai-card-hints-deck-legal-v1917.json`, `data/manifests/deck-legal-ai-approval-v1917-manifest.json`, `data/scenarios/ai-deck-legal-v1917-smokes.json`. Der Automation-Cursor wurde nach V1.9.18 weitergesetzt.
- V1.9.18 Generische Upgrade-/Root-/Server-Fähigkeiten ist als WIP gestartet. Alle 15 Zielkarten haben WIP-Runtime-Definitionen mit finalen display-only Texten; der Katalog schützt die Zielmenge über `ONR_V1_9_18_WIP_CARD_IDS`, ohne Runtime-/AI-Promotion. Führende WIP-Artefakte: `docs/derived/V1_9_18_DETAILED_PLAN.md`, `docs/derived/V1_9_18_REQUIREMENTS.md`, `docs/derived/V1_9_18_GENERIC_UPGRADE_ROOT_SERVER_SPEC.md`, `docs/derived/V1_9_18_TEST_MATRIX.md`, `docs/derived/V1_9_18_REQUIREMENTS_REVIEW.md`, `docs/derived/V1_9_18_IMPLEMENTATION_REVIEW.md`, `data/scenarios/v1918-generic-upgrade-root-server-wip-smoke.json`. Completion-Gate bleibt offen.
- V1.9.20 Globale Modifier, Handgröße, Action Economy und persistente Sonderzustände ist umgesetzt und final reviewt. Alle 26 Zielkarten sind `human_playable`, `deck_legal` und `ai_supported`; MRAM-MU, rezzed Action-Economy-Assets, Fortress-Architects-Rez-Kosten, Main-Office-Handlimit und Loan-from-Chiba-Recurring-State sind side-sicher und replay-/StateHash-stabil abgedeckt. Führende Artefakte: `docs/derived/V1_9_20_IMPLEMENTATION_REVIEW.md`, `docs/derived/V1_9_20_FINAL_REVIEW.md`, `data/manifests/card-implementation-manifest-1.9.20.json`, `data/rules/mechanics-coverage-1.9.20.json`, `data/scenarios/v1920-global-modifier-special-state-release-smoke.json`, `data/ai/ai-card-hints-deck-legal-v1920.json`, `data/manifests/deck-legal-ai-approval-v1920-manifest.json`, `data/scenarios/ai-deck-legal-v1920-smokes.json`. Der Automation-Cursor wurde nach V1.9.21 weitergesetzt.
