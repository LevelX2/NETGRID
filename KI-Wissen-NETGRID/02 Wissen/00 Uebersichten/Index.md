...
- V1.9.15 Run Flow, Access, Multiaccess und Ambush on Access ist detailgeplant und requirements-freigegeben, aber noch nicht implementiert. Führende WIP-Artefakte: `docs/derived/V1_9_15_DETAILED_PLAN.md`, `docs/derived/V1_9_15_REQUIREMENTS.md`, `docs/derived/V1_9_15_RUN_ACCESS_MULTIACCESS_SPEC.md`, `docs/derived/V1_9_15_TEST_MATRIX.md`, `docs/derived/V1_9_15_REQUIREMENTS_REVIEW.md`. Der Automation-Cursor steht auf V1.9.15 `implementing`; Kartenpromotion bleibt bis zu Engine-/KI-/Gate-Abdeckung gesperrt.
