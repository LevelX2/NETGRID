...
- V1.9.12 Counter/Virus/Purge/Recurring ist in Umsetzung. Der erste WIP umfasst Detailplan, Requirements, Spec, Testmatrix, Requirements Review, Implementation Review, WIP-Szenario, Engine-Runtime-Definitionen fuer alle elf Zielkarten sowie WIP-Manifest, Mechanics-Coverage, AI-Hints, AI-Smoke-Plan und AI-Approval-Manifest. JSON-Validation, Engine (213), Catalog (26), AI (84), Server (72) und Typecheck sind grün, aber finale Catalog/Web-Promotion, Web, volle Pflichtchecks, Final Review und Webclient-Version sind offen. Der Automation-Cursor steht auf V1.9.12 `implementing`.
