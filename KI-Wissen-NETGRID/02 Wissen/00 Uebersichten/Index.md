...
- V1.9.16 Program Subtypes, Hosting, Stealth, Worm und Installed-card Destroy ist detailgeplant und im Runtime-/Engine-/AI-Artefakt-WIP: alle 16 Zielkarten haben WIP-Runtime-Definitionen, der Katalog hält sie als No-Promotion-Zielmenge zurück. Link-/Trace-, Stealth-/Recurring- und Fragmentation-Storm-Erfolgsgate-Smokes sind grün; Fragmentation Storm ist fuer Erfolg/Misserfolg replay-/StateHash-stabil. KI-Artefakte sind als `pending_engine_full_gate` angelegt, aber nicht promotet. Hosting, volle Pflichtchecks, Final Review und Promotion bleiben offen; Engine, Catalog, AI, Server, Web und Typecheck sind als Teilchecks grün. Führende WIP-Artefakte: `docs/derived/V1_9_16_DETAILED_PLAN.md`, `docs/derived/V1_9_16_REQUIREMENTS.md`, `docs/derived/V1_9_16_PROGRAM_SUBTYPE_HOSTING_STEALTH_SPEC.md`, `docs/derived/V1_9_16_TEST_MATRIX.md`, `docs/derived/V1_9_16_REQUIREMENTS_REVIEW.md`, `docs/derived/V1_9_16_IMPLEMENTATION_REVIEW.md`, `data/scenarios/v1916-program-subtype-hosting-stealth-smoke.json`, `data/manifests/card-implementation-manifest-1.9.16.json`, `data/rules/mechanics-coverage-1.9.16.json`, `data/ai/ai-card-hints-deck-legal-v1916.json`, `data/scenarios/ai-deck-legal-v1916-smokes.json`, `data/manifests/deck-legal-ai-approval-v1916-manifest.json`. Der Automation-Cursor steht auf V1.9.16 `implementing`.
