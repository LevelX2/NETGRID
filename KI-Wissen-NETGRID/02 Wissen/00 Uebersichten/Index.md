...
- V1.9.15 Run Flow, Access, Multiaccess und Ambush on Access ist detailgeplant und im Engine-/Daten-WIP: alle 14 Zielkarten haben WIP-Runtime-Definitionen, der Katalog hält sie als No-Promotion-Zielmenge zurück; `Priority Wreck` deckt R&D-Multiaccess mit Hidden-Queue-Schutz und Replay/StateHash ab, `Cerberus`/`Mastiff` nutzen das side-sichere Trace-Bid-Fenster, und `New Blood` ist nach sichtbarem Runner-Run-Versuch legal. Führende WIP-Artefakte: `docs/derived/V1_9_15_DETAILED_PLAN.md`, `docs/derived/V1_9_15_REQUIREMENTS.md`, `docs/derived/V1_9_15_RUN_ACCESS_MULTIACCESS_SPEC.md`, `docs/derived/V1_9_15_TEST_MATRIX.md`, `docs/derived/V1_9_15_REQUIREMENTS_REVIEW.md`, `docs/derived/V1_9_15_IMPLEMENTATION_REVIEW.md`, `data/scenarios/v1915-run-access-multiaccess-wip-smoke.json`, `data/manifests/card-implementation-manifest-1.9.15.json`, `data/rules/mechanics-coverage-1.9.15.json`, `data/ai/ai-card-hints-deck-legal-v1915.json`, `data/scenarios/ai-deck-legal-v1915-smokes.json`. Der Automation-Cursor steht auf V1.9.15 `implementing`; Kartenpromotion bleibt bis zu finaler Daten-/KI-/Gate-Abdeckung gesperrt.
