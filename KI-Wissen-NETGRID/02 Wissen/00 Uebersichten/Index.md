...
- V1.9.16 Program Subtypes, Hosting, Stealth, Worm und Installed-card Destroy ist detailgeplant und im Runtime-WIP: alle 16 Zielkarten haben WIP-Runtime-Definitionen, der Katalog hält sie als No-Promotion-Zielmenge zurück. Führende WIP-Artefakte: `docs/derived/V1_9_16_DETAILED_PLAN.md`, `docs/derived/V1_9_16_REQUIREMENTS.md`, `docs/derived/V1_9_16_PROGRAM_SUBTYPE_HOSTING_STEALTH_SPEC.md`, `docs/derived/V1_9_16_TEST_MATRIX.md`, `docs/derived/V1_9_16_REQUIREMENTS_REVIEW.md`, `docs/derived/V1_9_16_IMPLEMENTATION_REVIEW.md`. Der Automation-Cursor steht auf V1.9.16 `implementing`.
