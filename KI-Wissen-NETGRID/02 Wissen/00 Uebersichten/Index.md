...
- V1.9.12 Counter/Virus/Purge/Recurring ist in Umsetzung. Der erste WIP umfasst Detailplan, Requirements, Spec, Testmatrix, Requirements Review, Implementation Review, WIP-Szenario, Engine-Runtime-Definitionen fuer alle elf Zielkarten sowie WIP-Manifest, Mechanics-Coverage, AI-Hints, AI-Smoke-Plan und AI-Approval-Manifest. JSON-Validation, Engine (213), Catalog (26), AI (84), Server (72), Web (76), Typecheck, Lint und Build sind grün; der Build zeigt nur die bekannte nicht-blockierende Turbopack-NFT-Warnung. Offen bleiben finale Catalog/Web-Promotion, Workspace-`test`, Final Review und Webclient-Version. Der Automation-Cursor steht auf V1.9.12 `implementing`.
